...
public class TestSQLRepositoryAPI extends SQLRepositoryTestCase {
    ...
    public void testLists() throws Exception {
        ...
        child.setProperty("testList", "subjects", new String[] { "a", "b" });
        // simple list as List
        child.setProperty("testList", "contributors", new ArrayList<String>(
                Arrays.asList("c", "d")));
        ...
        Object subjects = child.getProperty("testList", "subjects");
        assertTrue(subjects instanceof String[]);
        assertEquals(Arrays.asList("a", "b"),
                Arrays.asList((String[]) subjects));
        Object contributors = child.getProperty("testList", "contributors");
    ...
    public void testCopyContent() throws ClientException {
        ...
        doc.setProperty("testList", "subjects", new String[] { "a", "b" });
        ...
        assertEquals(Arrays.asList("a", "b"),
                Arrays.asList((String[]) copy.getProperty("testList",
                        "subjects")));
