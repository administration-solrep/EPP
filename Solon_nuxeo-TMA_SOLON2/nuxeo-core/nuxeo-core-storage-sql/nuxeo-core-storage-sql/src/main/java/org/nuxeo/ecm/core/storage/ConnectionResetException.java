...
public class ConnectionResetException extends StorageException {
    ...
    public ConnectionResetException(final String message) {
        super(message);
    }

    public ConnectionResetException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public ConnectionResetException(final Throwable cause) {
        super(cause);
    }
