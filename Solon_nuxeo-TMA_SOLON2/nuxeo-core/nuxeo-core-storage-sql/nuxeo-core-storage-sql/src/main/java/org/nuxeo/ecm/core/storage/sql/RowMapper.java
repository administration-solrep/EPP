...
public interface RowMapper {
    ...
    */
    List<? extends RowId> read(Collection<RowId> rowIds) throws StorageException;
    ...
    */
    public static final class RowUpdate implements Serializable {
        ...
        public RowUpdate(final Row row, final Collection<String> keys) {
            this.row = row;
            this.keys = keys;
        }
        ...
        private boolean equal(final RowUpdate other) {
    ...
    */
    Row readChildHierRow(Serializable parentId, String childName, boolean complexProp) throws StorageException;
    ...
    */
    List<Row> readChildHierRows(Serializable parentId, boolean complexProp) throws StorageException;
    ...
    * @throws StorageException
    */
    List<Row> getVersionRows(Serializable versionSeriesId) throws StorageException;
    ...
    * @throws StorageException
    */
    List<Row> getProxyRows(Serializable searchId, boolean byTarget, Serializable parentId) throws StorageException;
    ...
    */
    ...
    public static final class IdWithTypes implements Serializable {
        ...
        public IdWithTypes(final Serializable id, final String primaryType, final String[] mixinTypes) {
            this.id = id;
            this.primaryType = primaryType;
            this.mixinTypes = mixinTypes;
        }

        public IdWithTypes(final Node node) {
            this.id = node.getId();
    ...
    public static final class CopyHierarchyResult implements Serializable {
        ...
        public CopyHierarchyResult(final Serializable copyId, final Invalidations invalidations) {
            this.copyId = copyId;
    ...
    * @throws StorageException
    */
    CopyHierarchyResult copyHierarchy(IdWithTypes source, Serializable destParentId, String destName, Row overwriteRow) throws StorageException;
