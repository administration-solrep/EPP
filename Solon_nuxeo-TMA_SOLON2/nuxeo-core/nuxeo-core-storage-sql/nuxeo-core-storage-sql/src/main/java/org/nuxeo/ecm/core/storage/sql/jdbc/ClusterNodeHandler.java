...
public class ClusterNodeHandler {
    ...
    public ClusterNodeHandler(final Mapper clusterNodeMapper, final RepositoryDescriptor repositoryDescriptor) throws StorageException {
    ...
    */
    public void addQueue(final InvalidationsQueue queue) {
    ...
    */
    public void removeQueue(final InvalidationsQueue queue) {
    ...
    */
    public void propagateInvalidations(final Invalidations invalidations, final InvalidationsQueue skipQueue) {
    ...
    */
    public void sendClusterInvalidations(final Invalidations invalidations) throws StorageException {
