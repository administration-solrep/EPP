...
public abstract class AbstractPageProvider<T> implements PageProvider<T> {
	...
	public long getPageAffichee() {
		this.pageAffichee = getCurrentPageIndex() +1;
		return this.pageAffichee;
	}

	public void setPageAffichee(long pageAffichee) {
    ...
    public void goTo() {
        ...
        offset = (this.pageAffichee-1) * pageSize;
        pageChanged();
        refresh();
    }
