	...
	public Boolean handleLoginPrompt(HttpServletRequest httpRequest, HttpServletResponse httpResponse, String baseURL) {
		try {
			...
			if (requestedUrl != null && !requestedUrl.equals("")) {
				parameters.put(REQUESTED_URL, URLEncoder.encode(requestedUrl, "UTF-8"));
			}
			...
			if (loginError != null) {
				if (ERROR_USERNAME_MISSING.equals(loginError)) {
					...
					parameters.put(LOGIN_ERROR_MESSAGE, (String) httpRequest.getAttribute(LOGIN_ERROR_MESSAGE));
				} else {
