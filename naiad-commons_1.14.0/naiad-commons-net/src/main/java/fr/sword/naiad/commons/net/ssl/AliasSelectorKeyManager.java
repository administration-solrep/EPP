...
public class AliasSelectorKeyManager implements X509KeyManager {
	...
	/**
	 * Default constructor
	 * @param keyManager the wrapped keyManager
	 * @param alias the alias to use in the communications
	 */
	...
	/**
	 * Get all aliases from the key manager. If any matches with the managed alias, then return it.
