...
public interface MailboxManagementService extends Serializable {
	 ...
	 * @param session
	 * @param pattern
	 *            matching the box title
	 * @param type
	 *            mailbox type (generic, personal, etc... or null to match all)
	 */
	 ...
	 * @return personal mailbox list.
	 */
	List<Mailbox> createPersonalMailboxes (CoreSession session, DocumentModel userModel);
