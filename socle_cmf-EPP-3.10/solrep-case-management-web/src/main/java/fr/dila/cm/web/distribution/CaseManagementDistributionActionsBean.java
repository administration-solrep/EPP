...
package fr.dila.cm.web.distribution;
...
import fr.dila.cm.caselink.CaseLinkMode;
...
import fr.dila.cm.distribution.DistributionInfo;
import fr.dila.cm.distribution.ParticipantItem;
...
public class CaseManagementDistributionActionsBean extends
    ...
    public String validateWizard() throws ClientException {
        ...
        if (distributionInfo != null) {
            ...
            if (mode == CaseLinkMode.ENTIRE_ENVELOPE || mode == CaseLinkMode.DOC_ONLY) {
