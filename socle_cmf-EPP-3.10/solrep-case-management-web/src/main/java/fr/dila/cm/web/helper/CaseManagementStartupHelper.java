...
public class CaseManagementStartupHelper extends StartupHelper {
	...
	private static final Log								log					= LogFactory
																						.getLog(CaseManagementStartupHelper.class);
	...
	public String initServerAndFindStartupPage () throws ClientException {
		...
		try {
			...
			Mailbox userMailbox = service.getUserPersonalMailbox(documentManager, currentNuxeoPrincipal.getModel());
			if (userMailbox != null) {
