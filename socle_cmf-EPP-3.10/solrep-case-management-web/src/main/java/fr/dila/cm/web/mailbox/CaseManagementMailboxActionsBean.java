...
package fr.dila.cm.web.mailbox;
...
public class CaseManagementMailboxActionsBean extends CaseManagementAbstractActionsBean {
	...
	protected static final Log						log					= LogFactory
																				.getLog(CaseManagementMailboxActionsBean.class);
	...
	protected void resetMailboxCache (Mailbox cachedMailbox, Mailbox newMailbox) throws ClientException {
		ResultsProvidersCache resultsProvidersCache = (ResultsProvidersCache) Component
				.getInstance("resultsProvidersCache");
	...
	public String createDraftCaseItem (String type) throws ClientException {
		...
		context.put(CaseManagementEventConstants.EVENT_CONTEXT_AFFILIATED_MAILBOX_ID, getCurrentMailbox()
