...
public class TestSQLBackend extends SQLBackendTestCase {
    ...
    public void testBulkFetch() throws Exception {
        ...
        List<Node> nodes = session.getNodesByIds(Arrays.asList(node1.getId(), node2.getId()), null);
    ...
    public void testBulkFetchProxies() throws Exception {
        ...
        List<Node> nodes = session.getNodesByIds(Arrays.asList(node0.getId(), proxy1.getId(), proxy2.getId()), null);
    ...
    public void testPath() throws Exception {
        ...
        List<Node> nodes = session.getNodesByIds(Arrays.asList(gee.getId(), moo.getId()), null);
    ...
    public void testPathDeep() throws Exception {
        ...
        // fetch last
        List<Node> nodes = session.getNodesByIds(Arrays.asList(last1.getId(), last2.getId()), null);
    ...
    public void testPathOptimizationsActivation() throws Exception {
        ...
        nodes = session.getNodesByIds(ids, null);
        assertEquals(1, nodes.size());
        res = session.query(sql, QueryFilter.EMPTY, false);
        assertEquals(4, res.size());
    }
