...
public class SQLSession implements Session<QueryFilter> {
    ...
    public PartialList<Document> query(String query, String queryType, QueryFilter queryFilter, long countUpTo) {
        ...
        List<Document> list = getDocumentsById(pl, null);
    ...
    @Override
    public List<Document> getDocumentsById(List<Serializable> ids, PrefetchInfo prefetchInfo) {
        List<Document> docs = new ArrayList<>(ids.size());
        Set<String> tablenamesToLoad = buildTablesToLoad(prefetchInfo);
        List<Node> nodes = session.getNodesByIds(ids, tablenamesToLoad);
    ...
    private Set<String> buildTablesToLoad(PrefetchInfo prefetchInfo){
    	Set<String> tableNamesToLoad = null;
    	if(prefetchInfo != null){
    		tableNamesToLoad = session.getModel().retrieveFragmentForPrefetch(prefetchInfo);
    	}
    	return tableNamesToLoad;
    }
