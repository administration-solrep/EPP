...
public class TestPrefetch {
    ...
    public void testPrefetchInfoParsing() {
        ...
        Set<String> expectedFields = new HashSet<>(
                Arrays.asList("icon", "dc:title", "dc:description", "dc:modified", "dc:lastContributor"));
        assertEquals(expectedFields, new HashSet<>(Arrays.asList(prefetchInfo.getFields())));

        //Set<String> expectedSchemas = new HashSet<>(Arrays.asList("common", "dublincore", "file", "uid"));
        Set<String> expectedSchemas = new HashSet<>(Arrays.asList("file", "uid"));
        assertEquals(expectedSchemas, new HashSet<>(Arrays.asList(prefetchInfo.getSchemas())));
    }
    ...
    public void testDocumentModelPrefetch() {
        ...
        doc.setPropertyValue("common:icon", "foo/icon");  // not prefetched
