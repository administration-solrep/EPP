...
public class TestSQLRepositoryProperties {
 ...
 // NXP-2467
    ...
    public void testListWithNullFirst() throws Exception {
        ...
        session = coreFeature.reopenCoreSession();
        doc = session.getDocument(doc.getRef());
        assertTrue(Arrays.equals(values, (String[]) doc.getPropertyValue("participants")));
    }
    ...
    public void testPrefetchComplexProperty() throws Exception {
        ...
        assertFalse(doc.isPrefetched("attachments/0/name"));
    ...
    protected void changeDoc(String id, StateDiff diff) throws Exception {
        throw new UnsupportedOperationException("No support for DBS");
    }
