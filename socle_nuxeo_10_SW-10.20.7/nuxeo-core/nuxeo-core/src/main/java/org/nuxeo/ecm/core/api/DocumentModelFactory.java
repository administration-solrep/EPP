...
public class DocumentModelFactory {
     ...
     */
    public static DocumentModelImpl createDocumentModel(Document doc, String sid, PrefetchInfo customPrefetchInfo) {
        ...
        if(customPrefetchInfo != null) {
        	prefetchInfo = customPrefetchInfo;
        }
        Prefetch prefetch;
        ...
        String[] schemas = prefetchSchemas;
        if (schemas != null) {
