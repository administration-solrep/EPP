...
public class DossierUnlockBatchListener extends AbstractBatchEventListener {
	 ...
	 */
	private static final String		GET_LOCKED_DOCUMENT_QUERY	= "SELECT * FROM Document where "
	...
	protected void processEvent(CoreSession session, Event event) throws ClientException {
		...
		try {
			...
			suiviBatchService.createBatchResultFor(batchLoggerModel, "Nombre de dossiers déverrouillés", nbDocUnlocked,
