...
public class JetonMaitreImpl implements JetonMaitre {
	...
	public String getIdProprietaire() {
		return PropertyUtil.getStringProperty(doc, STSchemaConstant.JETON_MAITRE_SCHEMA,
				STSchemaConstant.JETON_MAITRE_ID_PROPRIETAIRE);
	}

	@Override
	public void setIdProprietaire(String id) {
		PropertyUtil.setProperty(doc, STSchemaConstant.JETON_MAITRE_SCHEMA,
				STSchemaConstant.JETON_MAITRE_ID_PROPRIETAIRE, id);
	}

	@Override
	public Long getNumeroJetonMaitre() {
		return PropertyUtil.getLongProperty(doc, STSchemaConstant.JETON_MAITRE_SCHEMA,
	...
	public void setTypeWebservice(String type) {
		PropertyUtil.setProperty(doc, STSchemaConstant.JETON_MAITRE_SCHEMA, STSchemaConstant.JETON_MAITRE_WEBSERVICE,
				type);
	}
