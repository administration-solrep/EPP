...
public class STRequeteurWidgetGeneratorServiceImpl extends DefaultComponent implements
		STRequeteurWidgetGeneratorService {
	...
	private static final Log					LOGGER					= LogFactory
																				.getLog(STRequeteurWidgetGeneratorServiceImpl.class);
