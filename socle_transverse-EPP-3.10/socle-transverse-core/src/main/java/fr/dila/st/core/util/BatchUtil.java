...
public class BatchUtil {
	...
	public static void removeDocDeletedState(final CoreSession session, final String documentType,
			final BatchLoggerModel batchLoggerModel, Long nbError) {
		...
		try {
			...
			suiviBatchService.createBatchResultFor(batchLoggerModel, infosBatch.toString(), nbRemoved, endTime
					- starttime);
			LOGGER.info(session, STLogEnumImpl.PROCESS_BATCH_TEC, infosBatch.toString());
