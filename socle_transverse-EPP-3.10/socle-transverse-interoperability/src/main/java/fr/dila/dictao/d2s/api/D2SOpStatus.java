package fr.dila.dictao.d2s.api;

public enum D2SOpStatus {
	...
	public static D2SOpStatus fromInt(int value) {
		D2SOpStatus returnValue = UNKNOWN;
		for (D2SOpStatus status : values()) {
