...
import fr.sword.xsd.commons.SolonEpgVersionConstants;
...
public class VersionHelper {
	...
	public static VersionResponse getVersionForWSsolonEpg() {
		VersionResponse response = new VersionResponse();
		SolonEpgVersion version = new SolonEpgVersion();
		response.setVersionSolonEpg(version);

		version.setActes(SolonEpgVersionConstants.ACTES);
		version.setAr(SolonEpgVersionConstants.AR);
		version.setSolonCommons(SolonEpgVersionConstants.SOLON_COMMONS);
		version.setWsSolonEpg(SolonEpgVersionConstants.WS_SOLON_EPG);
