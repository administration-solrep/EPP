...
public class SSLSocketFactoryBuilder {
	 ...
	 * 
	 * @param keyAlias
	 *            the keystore key alias to use
	 */
	public SSLSocketFactoryBuilder(String keyAlias) {
		this(keyAlias, System.getProperty("javax.net.ssl.keyStore"), System
				.getProperty("javax.net.ssl.keyStorePassword"), System.getProperty("javax.net.ssl.keyStoreType"),
				System.getProperty("javax.net.ssl.trustStore"), System.getProperty("javax.net.ssl.trustStorePassword"),
	 ...
	 * 
	 * @param keyAlias
	 *            the key alias to use in the generated SSL communications
	 * @param keystore
	 *            the keystore file
	 ...
	 *            the truststore type
	 */
	public SSLSocketFactoryBuilder(String keyAlias, String keystore, String keystorePassword, String keystoreType,
	...
	public org.apache.http.conn.ssl.SSLSocketFactory getApacheSSLSocketFactory(String protocol) throws IOException,
	...
	private KeyManager[] getKeyManagers() throws IOException, GeneralSecurityException {
		...
		try {
			fis = new FileInputStream(getKeystore());

			KeyStore kStore = KeyStore.getInstance(getKeystoreType());
			kStore.load(fis, getKeystorePassword().toCharArray());

			// Init the key manager factory with the loaded key store
			kmFact.init(kStore, getKeystorePassword().toCharArray());
	...
	private TrustManager[] getTrustManagers() throws IOException, GeneralSecurityException {
		...
		try {
			...
			kStore.load(fis, getTruststorePassword().toCharArray());
