...
#
# Usage : creer_branche_reponses_depuis_branche <old_version_branch> <new_version_branch> [release_dir]
#
# Script servant à créer une branche de livraison du projet Réponses à partir d'une autre branche.
#
# Argument:
...
export projects="socle_transverse socle_solrep reponses socle_cmf socle_dr"
