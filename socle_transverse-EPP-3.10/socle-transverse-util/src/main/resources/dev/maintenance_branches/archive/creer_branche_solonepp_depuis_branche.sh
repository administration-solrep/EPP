...
#
# Usage : creer_branche_solonepp_depuis_branche <old_version_branch> <new_version_branch> [release_dir]
#
# Script servant à créer une branche de livraison du projet SOLON EPP à partir d'une autre branche.
#
# Argument:
