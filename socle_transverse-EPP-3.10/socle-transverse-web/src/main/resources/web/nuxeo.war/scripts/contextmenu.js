...
function getMenuItemsToHideCallBacks(actionsToRemove)
{
    ...
    // display menu
    menu.css({'left':menuX-30,'top':menuY}).show();
    if (cur.shadow) shadow.css({width:menu.width(),height:menu.height(),left:menuX-28,top:menuY+2}).show();
