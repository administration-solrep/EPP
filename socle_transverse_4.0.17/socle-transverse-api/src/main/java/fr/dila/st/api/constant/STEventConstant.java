...
public final class STEventConstant {
     ...
     * property comment de l'event
     */
    public static final String DOC_REF_PROPERTY = "idDossier";
    // *************************************************************
    ...
    /**
     * événement : archivage mail utilisateurs
     */
    public static final String EVENT_ENVOI_MAIL_UTILISATEURS = "envoiMailUtilisateur";

    /**
     * événement : archivage mail
     */
    public static final String EVENT_GENERAL_ENVOI_MAIL = "envoiMailGeneralEvent";
    ...
    /**
     * commentaire : edémarrage de la feuille de route
     */
    public static final String COMMENT_FEUILLE_ROUTE_RESTART = "label.journal.comment.fdrRestart";

    /**
     * commentaire : redémarrage de la question
     */
    public static final String COMMENT_FEUILLE_ROUTE_ET_DOSSIER_RESTART = "label.journal.comment.fdrEtDossierRestart";

    /**
     * événement : redémarrage de la feuille de route
     */
    public static final String EVENT_FEUILLE_ROUTE_RESTART = "feuilleRouteRestart";

    /**
     * événement : modification d'une note d'étape
     */
    public static final String EVENT_COMMENT_UPDATED = "commentUpdated";
    ...
    /**
     * Événement de changement gouvernement / migration.
     */
    public static final String CHANGEMENT_GVT_EVENT = "changementGouvernementEvent";
    public static final String MIGRATION_MIN_COMMENT = "label.journal.comment.migration.ministere";
    public static final String MIGRATION_DIR_COMMENT = "label.journal.comment.migration.direction";
    public static final String MIGRATION_UST_COMMENT = "label.journal.comment.migration.unite.structurelle";
    public static final String MIGRATION_PST_COMMENT = "label.journal.comment.migration.poste";
    ...
    public static final String BATCH_EVENT_PURGE_TOKEN = "purgeTokenEvent";

    public static final String UNLOCK_ORGANIGRAMME_BATCH_EVENT = "unlockOrganigrammeBatchEvent";

    public static final String ORGANIGRAMME_NODE_MODIFIED = "organigrammeNodeModified";

    public static final String ORGANIGRAMME_NODE_MODIFIED_PARAM_NODE = "node";

    public static final String ORGANIGRAMME_NODE_MODIFIED_PARAM_OLD_NODE = "oldNode";
