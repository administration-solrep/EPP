...
public interface STLogger {
    ...
    void debug(final STLogEnum codeEnum, final Throwable exc);
    ...
    void info(CoreSession session, STLogEnum codeEnum, String message);

    void info(final STLogEnum codeEnum, final Throwable exc);
     ...
     * Méthode warn spécifique à n'utiliser que si aucune session n'existe
     */
    void warn(final STLogEnum codeEnum, final Throwable exc, final String message);
    ...
    void warn(final CoreSession session, final String message);
     ...
     * Méthode error spécifique à n'utiliser que si aucune session n'existe
     */
    void error(final STLogEnum codeEnum, final Throwable exc, final String msg);

    /**
     * Méthode error spécifique à n'utiliser que si aucune session n'existe
     */
    void error(final STLogEnum codeEnum, final String msg);
