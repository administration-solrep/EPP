...
public class EtatApplicationImpl extends STDomainObjectImpl implements EtatApplication {
    ...
    @Override
    public boolean getRestrictionAccesTechnique() {
        return getBooleanProperty(
            STSchemaConstant.ETAT_APPLICATION_SCHEMA,
            STSchemaConstant.ETAT_APPLICATION_RESTRICTION_ACCES_TECHNIQUE_PROPERTY
        );
    }

    @Override
    public void setRestrictionAccesTechnique(boolean restrictionAccesTechnique) {
        setProperty(
            STSchemaConstant.ETAT_APPLICATION_SCHEMA,
            STSchemaConstant.ETAT_APPLICATION_RESTRICTION_ACCES_TECHNIQUE_PROPERTY,
            restrictionAccesTechnique
        );
    }
