...
@Operation(
    id = CheckDirectionsOperation.ID,
    category = CaseConstants.CASE_MANAGEMENT_OPERATION_CATEGORY,
    label = "CheckDirections",
    description = "Vérifie les liens ministères-directions"
)
public class CheckDirectionsOperation {
    ...
    public void run() throws Exception {
        LOGGER.info(
            ...
            "Lancement de la procédure de vérification des nors directions en mode " + mode + "."
        );
    ...
    private void checkNode(
        ...
        OrganigrammeType parentType,
        String lettreDirection,
        String idMinistere
    ) {
            ...
            if (OrganigrammeType.MINISTERE.equals(parentType)) {
                ...
                if (lettreDirection != null && !lettreDirection.equals(actuelleLettreDirection)) {
                    if (INFO_MODE.equalsIgnoreCase(mode)) {
                        ...
                        message.append(") pour le ministère d'id : ").append(idMinistere);
                        message
                            .append(". Lettre direction ")
                            .append(
                                StringUtils.isNotBlank(actuelleLettreDirection) ? actuelleLettreDirection : "(vide)"
                            );
