...
public class RequeteurServiceImpl extends DefaultComponent implements RequeteurService {
    ...
    @Override
    public List<DocumentModel> query(CoreSession session, RequeteExperte requeteExperte) {
    ...
    @Override
    public Long countResults(CoreSession session, RequeteExperte requeteExperte) {
    ...
    public String getPattern(CoreSession session, QueryAssembler assembler, String queryPart, Map<String, Object> env) {
        String fullquery = QueryHelper.getFullQuery(assembler, queryPart);
