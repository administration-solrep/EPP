...
public class SecurityServiceImpl implements SecurityService {
    ...
    @Override
    public void addAceToAcp(ACP acp, String aclName, String group, String privilege) {
    ...
    @Override
    public void addAceToAcl(DocumentModel doc, String aclName, String group, String privilege) {
        ACP acp = doc.getACP();
        ACL acl = acp.getOrCreateACL(aclName);
    ...
    @Override
    public void addAceToSecurityAcl(DocumentModel doc, String baseFunction, String privilege) {
    ...
    public void addAceToAcpInFirstPosition(ACP acp, String aclName, String group, String privilege, boolean grant) {
        ...
        if (acl != null) {
            ...
            throw new NuxeoException(
                "l'ACL '" + aclName + "' existe déjà dans les ACP ! On ne peut pas l'insérer en première position !"
            );
        }
