...
public class TestLogEntryProvider extends PersistenceTestCase {
    ...
    public void testHavingKey() {
        ...
        List<LogEntry> entries = providerUnderTest.nativeQueryLogs(
            "log.id = " + entry.getId() + " and log.extendedInfos['id'] is not null",
            1,
            10
        );
    ...
    private Map<String, ExtendedInfo> createExtendedInfos() {
    ...
    private LogEntry doCreateEntry(String docId) {
    ...
    private LogEntry doCreateEntryAndPersist(String docId) {
