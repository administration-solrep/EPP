...
public abstract class DictaoServiceCaller {
    ...
    /**
     * Set the client Key alias to use for secure communications on the provided
     * service
     * 
     * @param service
     * @param alias
    ...
    public void setClientKeyAlias(Object service, String alias) throws DictaoServiceCallerException {
        ...
        try {
            ...
            if (service instanceof BindingProvider) {
                ...
                SSLSocketFactory sslf = sslfg.getSSLSocketFactory("TLS", SSLSocketFactoryBuilder.getKeystorePwd(),
                        SSLSocketFactoryBuilder.getTruststorePwd());
