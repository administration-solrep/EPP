...
import fr.sword.xsd.reponses.ChercherLegislaturesRequest;
...
public class WSAttributionProxy extends AbstractWsProxy implements WSAttribution {
	...
	public ChercherLegislaturesResponse chercherLegislatures() throws Exception {
		return doPost(WSAttribution.METHOD_NAME_CHERCHER_LEGISLATURES, new ChercherLegislaturesRequest(), ChercherLegislaturesResponse.class);
	}
