...
public class SSLSocketFactoryBuilderTest {
	...
	public void testSSLSocketFactoryBuilder() {
		...
		Assert.assertEquals(DICTAO_KEYSTORE_PASS, SSLSocketFactoryBuilder.getKeystorePwd());
		...
		Assert.assertEquals(DICTAO_TRUSTSTORE_PASS, SSLSocketFactoryBuilder.getTruststorePwd());
