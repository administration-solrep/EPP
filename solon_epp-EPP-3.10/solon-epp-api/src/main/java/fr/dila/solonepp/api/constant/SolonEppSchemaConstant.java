...
public final class SolonEppSchemaConstant {
    ...
    // *************************************************************
    // Schéma organigramme institution
    // *************************************************************
    /**
     * Schéma de l'organigramme institution.
     */
    public static final String INSTITUTION_SCHEMA = "institution";

    /**
     * Ensemble des institutions.
     */
    public static final Set<InstitutionsEnum> INSTITUTIONS_VALUES = new HashSet<InstitutionsEnum>(
    		Arrays.asList(InstitutionsEnum.GOUVERNEMENT, 
     ...
     */
    public static final String GOUVERNEMENT_SCHEMA = "gouvernement";
     ...
     */
    public static final String DOSSIER_DATE_REFUS_PROCEDURE_ENGAGEMENT_SENAT_PROPERTY = "dateRefusProcedureEngagementSenat";
     ...
     */
    public static final String VERSION_MODE_CREATION_PUBLIE_DEMANDE_RECTIFICATION_VALUE = "PUBLIE_DEMANDE_RECTIFICATION";

    /**
     * Propriété mode de création du schéma version : Publication d'une version en mode delta pour demande de rectification.
     */
    public static final String VERSION_MODE_CREATION_PUBLIE_DELTA_DEMANDE_RECTIFICATION_VALUE = "PUBLIE_DELTA_DEMANDE_RECTIFICATION";

    /**
     * Propriété mode de création du schéma version : Publication d'une version suite à une validation de rectification.
     */
    public static final String VERSION_MODE_CREATION_PUBLIE_VALIDATION_RECTIFICATION_VALUE = "PUBLIE_VALIDATION_RECTIFICATION";
     ...
     */
    public static final String VERSION_MODE_CREATION_PUBLIE_VALIDATION_ANNULATION_VALUE = "PUBLIE_VALIDATION_ANNULATION";
     ...
     */
    public static final String VERSION_DATE_REFUS_PROCEDURE_ENGAGEMENT_SENAT_PROPERTY = "dateRefusProcedureEngagementSenat";
