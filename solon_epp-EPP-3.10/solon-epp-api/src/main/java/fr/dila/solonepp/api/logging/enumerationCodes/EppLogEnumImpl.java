...
public enum EppLogEnumImpl implements STLogEnum {
	 ...
	 */
	CREATE_PERIODE_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.PERIODE_TDR, "Création d'une période"),
	/**
	 * Création d'un organisme : {@link STTypesEnum#CREATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#ORGANISME_TDR}
	 */
	CREATE_ORGANISME_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.ORGANISME_TDR, "Création d'un organisme"),
	/**
	 * Création d'un membre : {@link STTypesEnum#CREATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#MEMBRE_TDR}
	 */
	CREATE_MEMBRE_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.MEMBRE_TDR, "Création d'un membre (tdr)"),
	/**
	 ...
	 */
	CREATE_CIRCONSCRIPTION_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.CIRCONSCRIPTION_TDR, "Création d'une circonscription"),
	
	//************************** MISE À JOUR ***********************************************
	/**
	 * Mise à jour d'une période : {@link STTypesEnum#UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#PERIODE_TDR}
	 */
	UPDATE_PERIODE_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.PERIODE_TDR, "Mise à jour d'une période"),
	/**
	 * Mise à jour d'un organisme : {@link STTypesEnum#UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#ORGANISME_TDR}
	 */
	UPDATE_ORGANISME_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.ORGANISME_TDR, "Mise à jour d'un organisme"),
	/**
	 * Mise à jour d'un membre : {@link STTypesEnum#UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#MEMBRE_TDR}
	 */
	UPDATE_MEMBRE_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.MEMBRE_TDR, "Mise à jour d'un membre (tdr)"),
	/**
	 ...
	 */
	UPDATE_CIRCONSCRIPTION_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.CIRCONSCRIPTION_TDR, "Mise à jour d'une circonscription"),
     ...
     */
    FAIL_GET_INSTITUTION(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, EppObjetsEnum.INSTITUTION, "Aucune institution trouvee."),
     ...
     */
    FAIL_ADD_INSTITUTION(STTypesEnum.FAIL_ADD, STPorteesEnum.TECHNIQUE, EppObjetsEnum.INSTITUTION, "Erreur lors de l'ajout d'une institution"),
     ...
     */
    FAIL_REMOVE_INSTITUTION(STTypesEnum.FAIL_DEL, STPorteesEnum.TECHNIQUE, EppObjetsEnum.INSTITUTION, "Erreur lors de la suppression d'une institution"),
     ...
     */
    FAIL_ASSOCIATE_INSTITUTION_GROUPS_TO_CONNECTED_USER_TEC(STTypesEnum.FAIL_ASSOCIATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.INSTITUTION, "Impossible d'associer les groupes institutions à l'utilisateur connecté."),
     ...
     */
    FAIL_ASSOCIATE_EPP_GROUPS_TO_CONNECTED_USER_TEC(STTypesEnum.FAIL_ASSOCIATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.EPP, "Impossible d'associer les groupes de SOLON EPP à l'utilisateur connecté."),
     ...
     */
    FAIL_ADD_ADDRESS_TEC(STTypesEnum.FAIL_ADD, STPorteesEnum.TECHNIQUE, EppObjetsEnum.ADDRESS, "Erreur lors de l'ajout de l'adresse."),
     ...
     */
    NOTIFICATION_TRANSITION_COMMUNICTION_TEC(STTypesEnum.NOTIFICATION, STPorteesEnum.TECHNIQUE, STObjetsEnum.COMMUNICATION, "Notification de transition à l'état \"en cours\" de la communication.") ,
     ...
     */
    CHANGE_MESSAGE_STATE_PROGRESS_OR_SOLVED_TO_IN_PROGRESS_TEC(STTypesEnum.CHANGE_STATE, STPorteesEnum.TECHNIQUE, STObjetsEnum.COMMUNICATION, "Passage de l'état \"en cours\" ou \"traité\" à \"en cours\"") ,
     ...
     */
    PUBLISH_VERSION_TEC(STTypesEnum.PUBLICATION, STPorteesEnum.TECHNIQUE, EppObjetsEnum.VERSION, "Publication de la version") ,
     ...
     */
    ACKNOWLEDGMENT_VERSION_TEC(STTypesEnum.ACKNOWLEDGMENT, STPorteesEnum.TECHNIQUE, EppObjetsEnum.VERSION, "Accusé de réception de la version de la communication"),
     ...
     */
    FAIL_ACKNOWLEDGMENT_VERSION_FONC(STTypesEnum.ACKNOWLEDGMENT, STPorteesEnum.FONCTIONNELLE, EppObjetsEnum.VERSION, "Echec de l'accusé de réception"),

    /**
     * Validation de la version. : {@link STTypesEnum#VALIDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#VERSION}
     */
    VALIDATE_VERSION_TEC(STTypesEnum.VALIDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.VERSION, "Validation de la version"),

    /**
     * Invalidation de la version. : {@link STTypesEnum#INVALIDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link EppObjetsEnum#VERSION}
     */
    INVALIDATE_VERSION_TEC(STTypesEnum.INVALIDATE, STPorteesEnum.TECHNIQUE, EppObjetsEnum.VERSION, "Invalidation de la version"),
     ...
     */
    GET_WSEVENEMENT_TEC(STTypesEnum.GET, STPorteesEnum.TECHNIQUE, EppObjetsEnum.WS_EVENEMENT, "Service web des événements.") ,
     ...
     */
    FAIL_GET_VERSION_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, EppObjetsEnum.VERSION, "Erreur lors de la récupération d'une version."),
     ...
     */
    FAIL_GET_VERSION_FONC(STTypesEnum.FAIL_GET, STPorteesEnum.FONCTIONNELLE, EppObjetsEnum.VERSION, "Erreur lors de la récupération d'une version (fonc)"),
     ...
     */
    FAIL_FILL_EVNT_DELEGATE_FIELD_TEC(STTypesEnum.FAIL_FILL, STPorteesEnum.TECHNIQUE, EppObjetsEnum.EVENEMENT_DELEGATE, "Erreur lors du renseignement d'un champ vide"),
     ...
     */
    FAIL_NAVIGATE_SEARCH_FONC(STTypesEnum.FAIL_NAVIGATE, STPorteesEnum.FONCTIONNELLE, EppObjetsEnum.SEARCH, "Erreur de navigation vers la recherche"),
     ...
     */
    FAIL_GET_MESSAGE_FONC(STTypesEnum.FAIL_GET, STPorteesEnum.FONCTIONNELLE, EppObjetsEnum.MESSAGE, "Erreur de récupération de message (fonc)"),
    /**
     ...
     */
    FAIL_GET_DESCRIPTOR_FONC(STTypesEnum.FAIL_GET, STPorteesEnum.FONCTIONNELLE, EppObjetsEnum.DESCRIPTOR, "Erreur de récupération du descriptor"),
    /**
    ...
    public String getCode() {
        ...
        code.append(type.getCodeNumberStr()).append(SEPARATOR_CODE).append(portee.getCodeNumberStr()).append(SEPARATOR_CODE).append(objet.getCodeNumberStr());
