...
public interface InformationsParlementairesService extends Serializable {
	 ...
	 * @throws Exception
	 */
	void callWsCreerDossierEpg(CoreSession session, Dossier dossier, Evenement evenement, Version version, boolean isPublier) throws Exception;
	 ...
	 * @throws Exception
	 */
	void callWsModifierDossierEpg(CoreSession session, Evenement evenement, Version version, PieceJointe pieceJointe) throws Exception;
}
