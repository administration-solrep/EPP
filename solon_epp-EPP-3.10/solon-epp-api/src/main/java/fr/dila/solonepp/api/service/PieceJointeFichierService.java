...
public interface PieceJointeFichierService extends Serializable {
     ...
     */
    DocumentModel getPieceJointeFichierRoot(CoreSession session) throws ClientException;
     ...
     * @throws ClientException
     */
    DocumentModel createBarePieceJointeFichier(CoreSession session) throws ClientException;
     ...
     * @throws ClientException
     */
    DocumentModel createPieceJointeFichier(CoreSession session, DocumentModel evenementDoc, DocumentModel pieceJointeFichierDoc) throws ClientException;
     ...
     * @throws ClientException
     */
    List<DocumentModel> updatePieceJointeFichierList(CoreSession session, DocumentModel evenementDoc, DocumentModel pieceJointeDoc, List<DocumentModel> pieceJointeFichierDocList, boolean strictMode) throws ClientException;
     ...
     * @throws ClientException
     */
    void removePieceJointeFichier(CoreSession session, DocumentModel pieceJointeDoc, String pieceJointeFichierId) throws ClientException;
     ...
     * @throws ClientException
     */
    List<DocumentModel> findAllPieceJointeFichier(CoreSession session, DocumentModel pieceJointeDoc) throws ClientException;
}
