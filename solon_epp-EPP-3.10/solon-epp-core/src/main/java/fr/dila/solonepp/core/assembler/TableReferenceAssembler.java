...
//        fr.dila.solonepp.api.domain.tablereference.Acteur currentActeur = currentActeurDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Acteur.class);
     ...
     */
    public static void assembleCirconscriptionForUpdate(DocumentModel newCirconscriptionDoc, DocumentModel currentCirconscriptionDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Circonscription newCirconscription = newCirconscriptionDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Circonscription.class);
        fr.dila.solonepp.api.domain.tablereference.Circonscription currentCirconscription = currentCirconscriptionDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Circonscription.class);
     ...
     */
    public static void assembleGouvernementForUpdate(DocumentModel newGouvernementDoc, DocumentModel currentGouvernementDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Gouvernement newGouvernement = newGouvernementDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Gouvernement.class);
        fr.dila.solonepp.api.domain.tablereference.Gouvernement currentGouvernement = currentGouvernementDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Gouvernement.class);
    ...
    public static void assembleIdentiteForUpdate(DocumentModel newIdentiteDoc, DocumentModel currentIdentiteDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Identite newIdentite = newIdentiteDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Identite.class);
        fr.dila.solonepp.api.domain.tablereference.Identite currentIdentite = currentIdentiteDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Identite.class);
    ...
    public static void assembleMandatForUpdate(DocumentModel newMandatDoc, DocumentModel currentMandatDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Mandat newMandat = newMandatDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Mandat.class);
        fr.dila.solonepp.api.domain.tablereference.Mandat currentMandat = currentMandatDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Mandat.class);
     ...
     */
    public static void assembleMembreGroupeForUpdate(DocumentModel newMembreGroupeDoc, DocumentModel currentMembreGroupeDoc)   {
        fr.dila.solonepp.api.domain.tablereference.MembreGroupe newMembreGroupe = newMembreGroupeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.MembreGroupe.class);
        fr.dila.solonepp.api.domain.tablereference.MembreGroupe currentMembreGroupe = currentMembreGroupeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.MembreGroupe.class);
    ...
    public static void assembleMinistereForUpdate(DocumentModel newMinistereDoc, DocumentModel currentMinistereDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Ministere newMinistere = newMinistereDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Ministere.class);
        fr.dila.solonepp.api.domain.tablereference.Ministere currentMinistere = currentMinistereDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Ministere.class);
    ...
    public static void assembleOrganismeForUpdate(DocumentModel newOrganismeDoc, DocumentModel currentOrganismeDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Organisme newOrganisme = newOrganismeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Organisme.class);
        fr.dila.solonepp.api.domain.tablereference.Organisme currentOrganisme = currentOrganismeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Organisme.class);
    ...
    public static void assemblePeriodeForUpdate(DocumentModel newPeriodeDoc, DocumentModel currentPeriodeDoc)   {
        fr.dila.solonepp.api.domain.tablereference.Periode newPeriode = newPeriodeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Periode.class);
        fr.dila.solonepp.api.domain.tablereference.Periode currentPeriode = currentPeriodeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Periode.class);
