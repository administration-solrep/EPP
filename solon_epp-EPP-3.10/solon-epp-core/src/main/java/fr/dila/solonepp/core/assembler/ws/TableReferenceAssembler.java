...
public class TableReferenceAssembler  {
     ...
     */
    public static DocumentModel toActeurDoc(CoreSession session, Acteur acteur, DocumentModel doc) throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.Acteur adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Acteur.class); 
     ...
     */    
    public static Circonscription toCirconscriptionXsd(fr.dila.solonepp.api.domain.tablereference.Circonscription circonscription) {
     ...
     * @throws ClientException
     */  
    public static DocumentModel toCirconscriptionDoc(CoreSession session, Circonscription circonscription, DocumentModel doc)throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.Circonscription adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Circonscription.class);
     ...
     * @throws ClientException
     */  
    public static DocumentModel toGouvernementDoc(CoreSession session, Gouvernement gouvernement, DocumentModel doc) throws ClientException{
        fr.dila.solonepp.api.domain.tablereference.Gouvernement adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Gouvernement.class);
...
ntite/Webservices.
     ...
     * @throws ClientException
     */  
    public static DocumentModel toIdentiteDoc(CoreSession session, Identite identite, DocumentModel doc) throws ClientException{
        fr.dila.solonepp.api.domain.tablereference.Identite adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Identite.class);
     ...
     * @throws ClientException 
     */
    public static Mandat toMandatXsd(CoreSession session, DocumentModel mandatDoc) throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.Mandat mandat = mandatDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Mandat.class);
    ...
    public static IdentiteDenormalise toIdentiteDenormaliseXsd(DocumentModel identiteDoc) {
        fr.dila.solonepp.api.domain.tablereference.Identite identite = identiteDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Identite.class);
     ...
     * @throws ClientException
     */
    public static DocumentModel toMandatDoc(CoreSession session, Mandat mandat, DocumentModel doc )throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.Mandat adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Mandat.class);
     ...
     * @throws ClientException
     */  
    public static DocumentModel toMembreGroupeDoc(CoreSession session, MembreGroupe membreGroupe, DocumentModel doc) throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.MembreGroupe adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.MembreGroupe.class);
     ...
     * @throws ClientException
     */
    public static DocumentModel toMinistereDoc(CoreSession session, Ministere ministere, DocumentModel doc) throws ClientException{
        fr.dila.solonepp.api.domain.tablereference.Ministere adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Ministere.class);
    ...
    public static Organisme toOrganismeXsd(DocumentModel organismeDoc) {
        fr.dila.solonepp.api.domain.tablereference.Organisme organisme = organismeDoc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Organisme.class);
     ...
     * @throws ClientException
     */
    public static DocumentModel toOrganismeDoc(CoreSession session, Organisme organisme, DocumentModel doc) throws ClientException{
        fr.dila.solonepp.api.domain.tablereference.Organisme adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Organisme.class);
     ...
     * @throws ClientException
     */  
    public static DocumentModel toPeriodeDoc(CoreSession session, Periode periode, DocumentModel doc) throws ClientException {
        fr.dila.solonepp.api.domain.tablereference.Periode adapted = doc.getAdapter(fr.dila.solonepp.api.domain.tablereference.Periode.class);
