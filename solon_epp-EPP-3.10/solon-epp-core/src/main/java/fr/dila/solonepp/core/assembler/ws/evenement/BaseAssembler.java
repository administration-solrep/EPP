...
public abstract class BaseAssembler implements Assembler {
     ...
     */
    protected void assembleNiveauLectureXsdToVersion(final NiveauLecture niveauLecture, final Version version) throws ClientException {
        if (niveauLecture != null) {
            ...
            if (niveauLecture.getCode() != null) {
                version.setNiveauLecture(NiveauLectureCodeAssembler.assembleXsdToNiveauLectureCode(niveauLecture.getCode()));
            }
        }
    }
     ...
     * @throws ClientException
     */
    public static NiveauLecture assembleNiveauLectureVersionToXsd(final Version version) throws ClientException {
        ...
        if (version.getNiveauLecture() != null) {
            final NiveauLectureCode niveauLectureCode = NiveauLectureCodeAssembler.assembleNiveauLectureCodeToXsd(version.getNiveauLecture());
     ...
     * @throws ClientException
     */
    protected String getMandatIdentifiant(final Mandat mandat) throws ClientException {
        ...
        if (exist) {
            ...
            throw new ClientException("Mandat inexistant: " + mandat.getId());
        }
     ...
     * @throws ClientException
     */
    protected List<String> getMandatsIdentifiant(final List<Mandat> mandatList) throws ClientException {
     ...
     * @throws ClientException
     */
    protected Depot assembleDepotTexteVersionToXsd(final Version version) throws ClientException {
        Depot depot = null;
     ...
     * @throws ClientException
     */
    protected Commission assembleCommissionVersionToXsd(final Version version) throws ClientException {
        Commission commission = null;
        final TableReferenceService tableReferenceService = SolonEppServiceLocator.getTableReferenceService();
        if (StringUtils.isNotBlank(version.getCommissionSaisieAuFond()) || version.getCommissionSaisiePourAvis() != null) {
            commission = new Commission();
            DocumentModel organismeDoc = tableReferenceService.getOrganismeById(session, version.getCommissionSaisieAuFond());
     ...
     * @throws ClientException
     */
    protected void assembleCommissionXsdToVersion(final Commission commission, final Version version) throws ClientException {
        if (commission != null) {
            final TableReferenceService tableReferenceService = SolonEppServiceLocator.getTableReferenceService();
            ...
            if (commissionSaisieAuFond != null && commissionSaisieAuFond.getId() != null) {
                ...
                if (exist) {
                    ...
                    throw new ClientException("Commission saisie au fond, organisme inexistant: " + commissionSaisieAuFond.getId());
                }
            ...
            if (saisiePourAvis != null) {
                ...
                for (final Organisme commissionSaisiePourAvis : saisiePourAvis) {
                    if (commissionSaisiePourAvis.getId() != null) {
                        final boolean exist = tableReferenceService.hasOrganisme(session, commissionSaisiePourAvis.getId());
                        if (exist) {
                            commissionPourAvis.add(commissionSaisiePourAvis.getId());
                        } else {
                            throw new ClientException("Commission saisie au fond, organisme inexistant: " + commissionSaisiePourAvis.getId());
                        }
                    }
                }
     ...
     * @throws ClientException
     */
    protected Depot assembleDepotRapportVersionToXsd(final Version version) throws ClientException {
        Depot depot = null;
    ...
    protected void doVerifyCopy() throws ClientException {
