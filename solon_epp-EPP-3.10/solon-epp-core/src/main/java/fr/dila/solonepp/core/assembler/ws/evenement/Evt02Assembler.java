...
public class Evt02Assembler extends BaseAssembler {
    ...
    public Evt02Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
    ...
    public void buildObject(final Evenement evenement, final Version version) throws ClientException {
        ...
        if (principal.isInstitutionSenat()) {
            ...
            /*
             * } else { if (eppEvt.getUrlDossierSenat() != null) { throw new EppClientException("l'URL du dossier du Sénat ne peut etre modifé que par le Sénat"); }
             */
        }
        ...
        if (principal.isInstitutionAn()) {
            ...
            /*
             * } else { if (eppEvt.getUrlDossierAn() != null) { throw new EppClientException("l'URL du dossier de l'AN ne peut etre modifé que par l'AN "); }
             */
        }
