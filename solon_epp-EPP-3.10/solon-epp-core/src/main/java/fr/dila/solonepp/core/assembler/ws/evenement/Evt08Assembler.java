...
import fr.sword.xsd.solon.epp.EppEvt08;
import fr.sword.xsd.solon.epp.EppEvtContainer;
import fr.sword.xsd.solon.epp.EvenementType;
import fr.sword.xsd.solon.epp.PieceJointe;

/**
 * {@link Assembler} pour {@link EppEvt08}
 * 
 * @author asatre
 * 
 */
public class Evt08Assembler extends BaseAssembler {

    private final EppEvt08 eppEvt;

    public Evt08Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);
        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt08();
        } else {
            eppEvt = new EppEvt08();
        }
    }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_08);
        eppEvtContainerResponse.setEvt08(eppEvt);
    }
