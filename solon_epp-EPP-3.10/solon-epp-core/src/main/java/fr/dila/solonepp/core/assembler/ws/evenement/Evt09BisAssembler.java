...
import fr.sword.xsd.solon.epp.EppEvt09Bis;
import fr.sword.xsd.solon.epp.EppEvtContainer;
import fr.sword.xsd.solon.epp.EvenementType;
import fr.sword.xsd.solon.epp.PieceJointe;

/**
 * {@link Assembler} pour {@link EppEvt09Bis}
 * 
 * @author asatre
 * 
 */
public class Evt09BisAssembler extends BaseAssembler {

    private final EppEvt09Bis eppEvt;

    public Evt09BisAssembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);

        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt09Bis();
        } else {
            eppEvt = new EppEvt09Bis();
        }
    }
    ...
    public EvenementType getEvenementType() {
        return EvenementType.EVT_09_BIS;
    }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_09_BIS);
        eppEvtContainerResponse.setEvt09Bis(eppEvt);
    }
