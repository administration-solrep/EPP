...
/**
 * {@link Assembler} pour {@link EppEvt10}
 * 
 * @author asatre
 * 
 */
public class Evt10Assembler extends BaseAssembler {

    private final EppEvt10 eppEvt;

    public Evt10Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);
        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt10();
        } else {
            eppEvt = new EppEvt10();
        }
    }
    ...
    public void buildObject(final Evenement evenement, final Version version) throws ClientException {
        ...
        if (eppEvt.getDateEngagementProcedure() != null) {
            version.setDateEngagementProcedure(eppEvt.getDateEngagementProcedure().toGregorianCalendar());
        }
    ...
    public void buildXsd(final Evenement evenement, final Version version) throws ClientException {
        ...
        if (version.getDateEngagementProcedure() != null) {
            eppEvt.setDateEngagementProcedure(DateUtil.calendarToXMLGregorianCalendar(version.getDateEngagementProcedure()));
        }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_10);
        eppEvtContainerResponse.setEvt10(eppEvt);
