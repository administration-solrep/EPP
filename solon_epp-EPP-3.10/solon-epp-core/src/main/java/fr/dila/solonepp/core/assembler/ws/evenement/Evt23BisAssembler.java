...
/**
 * {@link Assembler} pour {@link EppEvt23Bis}
 * 
 * @author asatre
 * 
 */
public class Evt23BisAssembler extends BaseAssembler {

    private final EppEvt23Bis eppEvt;

    public Evt23BisAssembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);

        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt23Bis();
        } else {
            eppEvt = new EppEvt23Bis();
        }
    }
    ...
    public EvenementType getEvenementType() {
        return EvenementType.EVT_23_BIS;
    }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_23_BIS);
        eppEvtContainerResponse.setEvt23Bis(eppEvt);
    }
