...
public class Evt41Assembler extends BaseAssembler {
    ...
    public Evt41Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
    ...
    public void buildObject(final Evenement evenement, final Version version) throws ClientException {
        ...
        version.setMotifIrrecevabilite(MotifIrrecevabiliteAssembler.assembleXsdToMotifIrrecevabilite(eppEvt.getMotifIrrecevabilite()));
    ...
    public void buildXsd(final Evenement evenement, final Version version) throws ClientException {
        eppEvt.setMotifIrrecevabilite(MotifIrrecevabiliteAssembler.assembleMotifIrrecevabiliteToXsd(version.getMotifIrrecevabilite()));
