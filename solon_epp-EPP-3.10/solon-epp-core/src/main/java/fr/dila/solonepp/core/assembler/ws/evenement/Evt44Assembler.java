...
public class Evt44Assembler extends BaseAssembler {
    ...
    public Evt44Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
    ...
    public void buildObject(final Evenement evenement, final Version version) throws ClientException {
        ...
        version.setRapportParlement(RapportParlementAssembler.assembleXsdToRapportParlement(eppEvt.getRapportParlement()));
    ...
    public void buildXsd(final Evenement evenement, final Version version) throws ClientException {
        eppEvt.setRapportParlement(RapportParlementAssembler.assembleRapportParlementToXsd(version.getRapportParlement()));
