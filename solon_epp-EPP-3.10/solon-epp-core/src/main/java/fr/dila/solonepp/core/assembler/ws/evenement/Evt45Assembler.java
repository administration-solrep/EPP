...
public class Evt45Assembler extends BaseAssembler {
    ...
    public Evt45Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
	...
	public void buildXsd(final Evenement evenement, final Version version) throws ClientException {
		...
		final SolonEppVocabularyService eppVocabularyService = SolonEppServiceLocator.getSolonEppVocabularyService();
		eppEvt.setRubrique(eppVocabularyService.getLabelFromId(SolonEppVocabularyConstant.RUBRIQUES_VOCABULARY,
				version.getRubrique(), STVocabularyConstants.COLUMN_LABEL));
