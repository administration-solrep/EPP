...
/**
 * {@link Assembler} pour {@link EppEvt49}
 * 
 * @author asatre
 * 
 */
public class Evt49Assembler extends BaseAssembler {

    private final EppEvt49 eppEvt;

    public Evt49Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);
        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt49();
        } else {
            eppEvt = new EppEvt49();
        }
    }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_49);
        eppEvtContainerResponse.setEvt49(eppEvt);
    }
}
