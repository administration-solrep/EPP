...
import fr.sword.xsd.solon.epp.EppPG02;
import fr.sword.xsd.solon.epp.EvenementType;
import fr.sword.xsd.solon.epp.PieceJointe;

public class Pg02Assembler extends BaseAssembler {

    private final EppPG02 eppEvt;

    public Pg02Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        super(session, principal);
        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getPG02();
        } else {
            eppEvt = new EppPG02();
        }
    }
    ...
    public void setEvtInContainer(EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.PG_02);
        eppEvtContainerResponse.setPG02(eppEvt);
    }

    @Override
    public EvenementType getEvenementType() {
        return EvenementType.PG_02;
    }
