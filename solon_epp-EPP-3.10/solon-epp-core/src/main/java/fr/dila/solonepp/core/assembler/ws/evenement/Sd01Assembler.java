...
public class Sd01Assembler extends BaseAssembler {
    ...
    public Sd01Assembler(final EppEvtContainer eppEvtContainer, final CoreSession session, final EppPrincipal principal) {
        ...
        for (final Organisme groupeParlementaire : eppEvt.getGroupeParlementaire()) {
            if (groupeParlementaire != null) {
                ...
                if (exist) {
                    ...
                    throw new ClientException("Commission saisie, organisme inexistant: " + groupeParlementaire.getId());
                }
            }
        }
