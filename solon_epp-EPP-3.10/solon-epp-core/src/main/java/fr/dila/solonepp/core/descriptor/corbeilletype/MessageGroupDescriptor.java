...
public class MessageGroupDescriptor {
     ...
     */
    @XNodeMap(value = "messageTypes/messageType", key = "@name", type = HashMap.class, componentType = MessageTypeDescriptor.class)
    private Map<String, MessageTypeDescriptor> messageTypeMap;

    /**
     * Table des types d'événement que peut contenir la corbeille.
     */
    @XNodeMap(value = "evenementTypes/evenementType", key = "@name", type = HashMap.class, componentType = EvenementTypeDescriptor.class)
