...
public class AfterEvenementEnInstanceListener implements PostCommitEventListener {
    ...
    public void handleEvent(Event event) throws ClientException {
        ...
        if (!event.getName().equals(LifeCycleConstants.TRANSITION_EVENT) ||
                !SolonEppLifecycleConstant.EVENEMENT_INSTANCE_STATE.equals(ctx.getProperty(LifeCycleConstants.TRANSTION_EVENT_OPTION_TO))) {
            return;
        }
        ...
        jetonService.createNotificationEvenement(session, evenementDoc, SolonEppSchemaConstant.JETON_DOC_NOTIFICATION_EVENEMENT_EN_INSTANCE_VALUE);
    }
