...
public class DenormalisationVersionListener implements EventListener {
    ...
    public void handleEvent(Event event) throws ClientException {
        ...
        if (SolonEppConstant.VERSION_DOC_TYPE.equals(docType)) {
            ...
            if (StringUtils.isNotBlank(version.getDescription()) && !version.getDescription().equals(version.getCommentaire())
                    || StringUtils.isNotBlank(version.getCommentaire()) && !version.getCommentaire().equals(version.getDescription())) {
