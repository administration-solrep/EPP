...
public class ReprisePasswordPosteWSOperation {
	...
	public void run() throws Exception {
		...
		IterableQueryResult res = QueryUtils.doSqlQuery(session, new String[] { FlexibleQueryMaker.COL_ID, "dc:title" },
				"select poste.id_organigramme , poste.ws_mdp from POSTE where poste.ws_mdp is not null", new Object[] {});
		if (res != null) {
			try {
