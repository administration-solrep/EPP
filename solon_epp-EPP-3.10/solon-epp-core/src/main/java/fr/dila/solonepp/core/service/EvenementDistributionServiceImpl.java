...
public class EvenementDistributionServiceImpl implements EvenementDistributionService {
     ...
     */
    protected DocumentModel createCaseLink(CoreSession session, DocumentModel mailboxDoc, DocumentModel evenementDoc, String messageType)
            throws ClientException {
        
        LOGGER.info(session, STLogEnumImpl.DISTRIBUTION_COMM_IN_MAIL_BOX_TEC,"communication = " + evenementDoc.getTitle() + ", mailbox = " +mailboxDoc.getTitle()) ;
        ...
        message.setCaseRepositoryName(evenementDoc.getRepositoryName());
        ...
        List<String> corbeilleList = corbeilleTypeService.findCorbeilleDistribution(institution, messageType, evenement.getTypeEvenement());
	...
	@Override
	public void sendMessageEmetteur(CoreSession session, DocumentModel evenementDoc) throws ClientException {
    ...
    @Override
    public void sendMessageDestinataire(CoreSession session, final DocumentModel evenementDoc) throws ClientException {
        ...
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                if (StringUtils.isBlank(destinataireInstitutionId)) {
                    throw new ClientException("Le destinataire du message doit être renseigné");
                }

                DocumentModel destinataireMailboxDoc = mailboxInstitutionService.getMailboxInstitution(session, destinataireInstitutionId);

                // Crée le message et envoie le message au destinataire
                createCaseLink(session, destinataireMailboxDoc, evenementDoc, SolonEppSchemaConstant.CASE_LINK_MESSAGE_TYPE_DESTINATAIRE_VALUE);
            }
        }.runUnrestricted();
    ...
    @Override
    public void sendMessageDestinataireCopie(CoreSession session, final DocumentModel evenementDoc) throws ClientException {
        ...
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                for (String destinataireInstitutionId : destinataireInstitutionIdList) {
                    ...
                    createCaseLink(session, destinataireMailboxDoc, evenementDoc, SolonEppSchemaConstant.CASE_LINK_MESSAGE_TYPE_COPIE_VALUE);
                }
            }
        }.runUnrestricted();
    ...
    @Override
    public void accuserReceptionMessageEmetteur(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc, final boolean validationManuelle) throws ClientException {

        LOGGER.info(session, STLogEnumImpl.ACKNOWLEDGMENT_MESSAGE_FROM_COMM_TRANSMITTER_TEC,"communication " + evenementDoc.getTitle()) ;
				...
				for (DocumentModel messageDoc : messageDocs) {
					...
					if (message.isArNecessaire()) {
                        ...
                        /*if (validationManuelle && arNonDonneCount >= 1) {
                          throw new ClientException("Les versions antérieures de la communication doivent toutes avoir un accusé de réception");
                        }*/
    ...
    @Override
    public void updateMessageAfterCreerBrouillon(CoreSession session, final DocumentModel evenementDoc, final DocumentModel versionDoc)
            throws ClientException {
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                for (DocumentModel messageDoc : messageDocList) {
                    ...
                    if (SolonEppSchemaConstant.VERSION_MODE_CREATION_BROUILLON_INIT_VALUE.equals(version.getModeCreation())) {
                        notificationType = SolonEppSchemaConstant.JETON_DOC_NOTIFICATION_BROUILLON_INITIALE_VALUE;
                        jetonService.createNotificationEvenement(session, dossierDoc, evenementDoc, versionDoc, messageDoc, notificationType);                        
                    } 
...
//                    } else {
//                        throw new ClientException("Mode de création inconnu: " + modeCreation);
//                    }
    ...
    @Override
    public void updateMessageAfterPublier(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
        ...
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                for (DocumentModel messageDoc : messageDocList) {
                    ...
                    String notificationType = null;
                    final String modeCreation = version.getModeCreation();
                    if (SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_INIT_VALUE.equals(version.getModeCreation())) {
    ...
    @Override
    public void updateMessageAfterDemanderValidation(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc) throws ClientException {
        final Version version = versionDoc.getAdapter(Version.class);
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                for (DocumentModel messageDoc : messageDocList) {
                    ...
                    String notificationType = null;
                    final String modeCreation = version.getModeCreation();
                    if (SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_DEMANDE_RECTIFICATION_VALUE.equals(version.getModeCreation())
                            || SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_DELTA_DEMANDE_RECTIFICATION_VALUE
                                    .equals(version.getModeCreation())
                            || SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_DEMANDE_ANNULATION_VALUE.equals(version.getModeCreation())) {
    ...
    @Override
    public void updateMessageAfterValider(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc, final String messageType) throws ClientException {
        final Version version = versionDoc.getAdapter(Version.class);
        new UnrestrictedSessionRunner(session) {
            ...
            public void run() throws ClientException {
                ...
                for (DocumentModel messageDoc : messageDocList) {
                    ...
                    String notificationType = null;
                    final String modeCreation = version.getModeCreation();
                    if (SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_VALIDATION_RECTIFICATION_VALUE.equals(modeCreation)
                            || SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_VALIDATION_ANNULATION_VALUE.equals(modeCreation)
                    ...
                    } else if (SolonEppSchemaConstant.VERSION_MODE_CREATION_PUBLIE_ANNULATION_VALUE.equals(modeCreation)) {
    ...
    @Override
    public void updateMessageAfterRejeter(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc, final String messageType) throws ClientException {
        new UnrestrictedSessionRunner(session) {
    ...
    @Override
    public void updateMessageAfterAbandonner(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc, final String messageType) throws ClientException {
        new UnrestrictedSessionRunner(session) {
    ...
    @Override
    public void updateMessageMajVisaInterne(CoreSession session, final DocumentModel dossierDoc, final DocumentModel evenementDoc,
            final DocumentModel versionDoc, final DocumentModel messageDoc) throws ClientException {
    ...
    @Override
    public void updateMessageAfterEnregister(CoreSession session, final DocumentModel evenementDoc, final DocumentModel versionDoc)
            throws ClientException {
    ...
    @Override
    public void updateMessageAfterSupprimerBrouillon(CoreSession session, final DocumentModel evenementDoc, final DocumentModel versionDoc) throws ClientException {
        new UnrestrictedSessionRunner(session) {
