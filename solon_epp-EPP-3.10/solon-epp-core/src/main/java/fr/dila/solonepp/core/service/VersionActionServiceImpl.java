...
public class VersionActionServiceImpl implements VersionActionService {
    ...
    @Override
    public List<String> findActionPossible(CoreSession session, DocumentModel evenementDoc, DocumentModel versionDoc, String messageType, String etatMessage) throws ClientException {
     ...
     */
    protected void addActionCreerEvenement(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
     ...
     * @param messageType Type de message (EMETTEUR, DESTINATAIRE, COPIE)
     */
    protected void addActionCreerAlerte(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
     ...
     * @param messageType Type de message (EMETTEUR, DESTINATAIRE, COPIE)
     */
    protected void addActionLeverAlerte(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
     ...
     * @param messageType Type de message (EMETTEUR, DESTINATAIRE, COPIE)
     */
    protected void addActionCompleter(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
        if (evenement.isEtatAnnule()) {
            return;
        }
     ...
     * @param messageType Type de message (EMETTEUR, DESTINATAIRE, COPIE)
     */
    protected void addActionRectifier(CoreSession session, List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
        if (evenement.isEtatAnnule()) {
            return;
        }
		if ("EVT45".equals(evenement.getTypeEvenement())) {
			try {
				...
				if (dossierService.getEvenementTypeDossierList(session, dossierDoc).contains("EVT48")
     ...
     * @param messageType Type de message (EMETTEUR, DESTINATAIRE, COPIE)
     */
    protected void addActionAnnuler(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) {
     ...
     */
    protected void addActionAccuserReception(List<String> actionPossibleList, Evenement evenement, Version version, String messageType) throws ClientException {
        final EvenementTypeService evenementTypeService = SolonEppServiceLocator.getEvenementTypeService();
