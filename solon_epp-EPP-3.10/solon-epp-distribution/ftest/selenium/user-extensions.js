...
Selenium.prototype.doRetrieveTestFolderPath = function() {
  storedVars['testfolderpath'] = "/home/admin/workspace/solon-epp/solon-epp-distribution/ftest/selenium/data/";
};

//sleep : This extension adds command 'sleep' that halts the execution of a test for the specified number of milliseconds. see http://wiki.openqa.org/display/SEL/sleep
