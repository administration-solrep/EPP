...
class ClearCopieUtils {    
    public static boolean run(final CoreSession session) {
        ...
        final StringBuilder query = new StringBuilder();
            ...
            query.append("SELECT e.ecm:uuid as id FROM Evenement as e where e.evt:typeEvenement = 'GENERIQUE02'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE03'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE04'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE05'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE06'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE07'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE08'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE09'");
        query.append(" OR e.evt:typeEvenement = 'GENERIQUE10'");
