...
/**
 * classe de description de la page de création d'une communication LEX 28 (EVT23Ter) : CMP - Enregistrement de la demande de nouvelle lecture
 * 
 * @author mbd
 * 
 */
public class CreateComm23TerPage extends AbstractCreateComm {
    ...
    protected Class<? extends AbstractDetailComm> getCreateResultPageClass() {
        return DetailComm23TerPage.class;
    }

    public DetailComm23TerPage createComm23Ter(String dateDepot, String numeroDepot, String commFond, String commAvis, String commentaire) {
