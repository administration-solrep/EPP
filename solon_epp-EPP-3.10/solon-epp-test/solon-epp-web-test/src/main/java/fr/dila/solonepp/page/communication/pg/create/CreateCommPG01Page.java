 ...
 * 
 * @author abianchi
 * @description classe de description de la creation de la page PG_01 : déclaration de politique générale 
 */
public class CreateCommPG01Page extends AbstractCreateComm {
    ...
    public static final String TYPE_COMM = "PG-01 : Déclaration de politique générale du PM devant l’AN (49-1C)";
	public static final String EMETTEUR_VALUE = "Gouvernement";
	public static final String DESTINATAIRE_VALUE = "Assemblée nationale";
    ...
    public DetailCommPG_01 createCommPG01(String idDossier, String objet, String datePresentation, String dateLettrePM) {
        getFlog().startAction("Création de la communication PG01");
...
//        checkValue(DESTINATAIRE, DESTINATAIRE_VALUE);
