 ...
 * 
 * @author abianchi
 * @description classe de description de la creation de la page PG_03 :
 *              déclaration de politique générale
 */
public class CreateCommPG03Page extends AbstractCreateComm {
	...
	/* values */
	public static final String TYPE_COMM = "PG-03 : Déclaration de politique générale du PM devant le Sénat avec demande d'approbation (49-4C)";
	...
	protected Class<? extends AbstractDetailComm> getCreateResultPageClass() {
		return DetailCommPG_03.class;
	}

	public DetailCommPG_03 createCommPG03(String idDossier, String objet, String datePresentation, String dateLettrePM) {

		getFlog().startAction("Creation de la communication PG03");
