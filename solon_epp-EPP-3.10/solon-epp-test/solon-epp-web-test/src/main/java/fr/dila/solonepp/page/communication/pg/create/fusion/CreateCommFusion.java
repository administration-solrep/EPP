package fr.dila.solonepp.page.communication.pg.create.fusion;
 ...
 */
public class CreateCommFusion extends AbstractCreateComm {
	...
	public static final String TYPE_COMM = "Fusion de dossiers - Déclaration de politique générale";

	@Override
	protected Class<? extends AbstractDetailComm> getCreateResultPageClass() {
		return DetailCommPGFusion.class;
	}

	public DetailCommPGFusion createCommFusion(String objet, String destinataire, String dossierCible) {
