...
public class DetailCommPG_03 extends AbstractDetailComm {
	...
	// * @return
	// */
	// public CompletionPG03Page rectifier() {
	// return clickOnButton(BOUTON_VALUE_RECTIFIER, CompletionPG02Page.class);
	// }
	//
	// public CompletionPG03Page completer() {
    ...
    protected Class<? extends AbstractCreateComm> getModifierResultPageClass() {
        return CreateCommPG03Page.class;
    }
}
