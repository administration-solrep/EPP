...
public class DetailCommPG_04 extends AbstractDetailComm {
    ...
    public static final String SELECT_VALUE_PG04 = "PG-04 : Résultat du vote sur la déclaration de politique générale";
	 ...
	 * @return
	 */
	public CompletionPG04Page rectifier() {
		return clickOnButton(BOUTON_VALUE_RECTIFIER, CompletionPG04Page.class);
	}
	
	public CompletionPG04Page completer() {
		return clickOnButton(BOUTON_VALUE_COMPLETER, CompletionPG04Page.class);
	}
    ...
    protected Class<? extends AbstractCreateComm> getModifierResultPageClass() {
        return CreateCommPG04Page.class;
    }
}
