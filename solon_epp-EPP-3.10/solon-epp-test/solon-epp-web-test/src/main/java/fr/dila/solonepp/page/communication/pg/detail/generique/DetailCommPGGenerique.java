package fr.dila.solonepp.page.communication.pg.detail.generique;
...
public class DetailCommPGGenerique extends AbstractDetailComm {
	 ...
	 * @return
	 */
	public CompletionPGGenerique rectifier() {
		return clickOnButton(BOUTON_VALUE_RECTIFIER, CompletionPGGenerique.class);
	}
    ...
    protected Class<? extends AbstractCreateComm> getModifierResultPageClass() {
        return CreateCommPGGenerique.class;
    }
}
