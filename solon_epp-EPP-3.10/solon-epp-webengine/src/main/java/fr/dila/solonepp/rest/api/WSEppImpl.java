...
public class WSEppImpl extends DefaultObject implements WSEpp {
	...
	public ChercherCorbeilleResponse chercherCorbeille(ChercherCorbeilleRequest request) throws Exception {
		...
		LOGGER.info(
				...
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_CHERCHER_CORBEILLE, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherCorbeilleRequest.class, response,
	...
	public ChercherDossierResponse chercherDossier(ChercherDossierRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_CHERCHER_DOSSIER, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherDossierRequest.class, response,
	...
	public NotifierTransitionResponse notifierTransition(NotifierTransitionRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_NOTIFIER_TRANSITION, ctx
						.getCoreSession().getPrincipal().getName(), request, NotifierTransitionRequest.class, response,
	...
	public NotifierVerrouResponse notifierVerrou(NotifierVerrouRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_NOTIFIER_VERROU, ctx
						.getCoreSession().getPrincipal().getName(), request, NotifierVerrouRequest.class, response,
	...
	public ChercherTableDeReferenceResponse chercherTableDeReference(ChercherTableDeReferenceRequest request)
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_CHERCHER_TABLE_REFERENCE, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherTableDeReferenceRequest.class,
						response, ChercherTableDeReferenceResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public MajTableResponse majTable(MajTableRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_MAJ_TABLE, ctx.getCoreSession()
						.getPrincipal().getName(), request, MajTableRequest.class, response, MajTableResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public ChercherIdentiteResponse chercherIdentite(ChercherIdentiteRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_CHERCHER_IDENTITE, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherIdentiteRequest.class, response,
	...
	public ChercherMandatParNORResponse chercherMandatParNor(ChercherMandatParNORRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_CHERCHER_MANDAT_PAR_NOR, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherMandatParNORRequest.class,
						response, ChercherMandatParNORResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public HasCommunicationNonTraiteesResponse hasCommunicationNonTraitees(HasCommunicationNonTraiteesRequest request)
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_HAS_COMMUNICATION, ctx
						.getCoreSession().getPrincipal().getName(), request, HasCommunicationNonTraiteesRequest.class,
						response, HasCommunicationNonTraiteesResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public TransmissionDatePublicationJOResponse transmissionDatePublicationJO(TransmissionDatePublicationJORequest request) throws Exception {
		long startTime = System.nanoTime();
		...
		LOGGER.info(
				...
				EppLogEnumImpl.GET_WSEPP_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEpp.METHOD_HAS_COMMUNICATION, ctx
						.getCoreSession().getPrincipal().getName(), request, TransmissionDatePublicationJORequest.class,
						response, TransmissionDatePublicationJOResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
