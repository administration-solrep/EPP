...
public class WSEvenementImpl extends DefaultObject implements WSEvenement {
	...
	public ChercherEvenementResponse chercherEvenement(ChercherEvenementRequest request) throws Exception {
		...
		LOGGER.info(
				...
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_CHERCHER_EVENEMENT, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherEvenementRequest.class, response,
	...
	public ChercherPieceJointeResponse chercherPieceJointe(ChercherPieceJointeRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_CHERCHER_PIECE_JOINTE, ctx
						.getCoreSession().getPrincipal().getName(), request, ChercherPieceJointeRequest.class,
						response, ChercherPieceJointeResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public CreerVersionResponse creerVersion(CreerVersionRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_CREER_VERSION, ctx
						.getCoreSession().getPrincipal().getName(), request, CreerVersionRequest.class, response,
	...
	public CreerVersionDeltaResponse creerVersionDelta(CreerVersionDeltaRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_CREER_VERSION_DELTA, ctx
						.getCoreSession().getPrincipal().getName(), request, CreerVersionDeltaRequest.class, response,
	...
	public ValiderVersionResponse validerVersion(ValiderVersionRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_VALIDER_VERSION, ctx
						.getCoreSession().getPrincipal().getName(), request, ValiderVersionRequest.class, response,
	...
	public AnnulerEvenementResponse annulerEvenement(AnnulerEvenementRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_ANNULER_EVENEMENT, ctx
						.getCoreSession().getPrincipal().getName(), request, AnnulerEvenementRequest.class, response,
	...
	public SupprimerVersionResponse supprimerVersion(SupprimerVersionRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_SUPPRIMER_VERSION, ctx
						.getCoreSession().getPrincipal().getName(), request, SupprimerVersionRequest.class, response,
	...
	public AccuserReceptionResponse accuserReception(AccuserReceptionRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_ACCUSER_RECEPTION, ctx
						.getCoreSession().getPrincipal().getName(), request, AccuserReceptionRequest.class, response,
	...
	public InitialiserEvenementResponse initialiserEvenement(InitialiserEvenementRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_INITIALISER_EVENEMENT, ctx
						.getCoreSession().getPrincipal().getName(), request, InitialiserEvenementRequest.class,
						response, InitialiserEvenementResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public EnvoyerMelResponse envoyerMel(EnvoyerMelRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_ENVOYER_MEL, ctx
						.getCoreSession().getPrincipal().getName(), request, EnvoyerMelRequest.class, response,
	...
	public RechercherEvenementResponse rechercherEvenement(RechercherEvenementRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_RECHERCHER_EVENEMENT, ctx
						.getCoreSession().getPrincipal().getName(), request, RechercherEvenementRequest.class,
						response, RechercherEvenementResponse.class)
						+ "---DURATION : " + duration + "ms ---\n");
		return response;
	}
	...
	public MajInterneResponse majInterne(MajInterneRequest request) throws Exception {
		...
		LOGGER.info(
				ctx.getCoreSession(),
				EppLogEnumImpl.GET_WSEVENEMENT_TEC,
				JaxBHelper.logInWsTransaction(WSEvenement.SERVICE_NAME, WSEvenement.METHOD_MAJ_INTERNE, ctx
						.getCoreSession().getPrincipal().getName(), request, MajInterneRequest.class, response,
	...
	private boolean isPasswordOutdated() {
		CoreSession session = ctx.getCoreSession();
		try {
			if (SolonEppServiceLocator.getProfilUtilisateurService().isUserPasswordOutdated(session,
			...
			LOGGER.warn(session, EppLogEnumImpl.GET_WSEPP_TEC,
					"Impossible de vérifier la validité de la date de changement de mot de passe", e);
			return false;
		}
	}
	...
	private boolean isPasswordTemporary() {
		...
		try {
			...
			LOGGER.warn(session, EppLogEnumImpl.GET_WSEPP_TEC,
					"Impossible de vérifier si le mot de passe est temporaire", e);
			return false;
		}
	}
}
