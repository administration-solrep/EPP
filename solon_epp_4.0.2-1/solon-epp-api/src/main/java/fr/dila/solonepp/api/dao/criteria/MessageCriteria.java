...
public class MessageCriteria {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MessageCriteria: ")
            .append("{caseDocumentId: ")
            .append(caseDocumentId)
            .append(", evenementId: ")
            .append(evenementId)
            .append(", messageType: ")
            .append(messageType)
            .append(", messageTypeIn: ")
            .append(messageTypeIn == null ? "null" : StringUtils.join(messageTypeIn, ", "))
            .append(", corbeille: ")
            .append(corbeille)
            .append(", checkReadPermission: ")
            .append(checkReadPermission)
            .append(", dossierAlerte: ")
            .append(dossierAlerte)
            .append(", dossierId: ")
            .append(dossierId)
            .append(", evenementType: ")
            .append(evenementType)
            .append(", evenementEmetteur: ")
            .append(evenementEmetteur)
            .append(", evenementDestinataire: ")
            .append(evenementDestinataire)
            .append(", evenementDestinataireCopie: ")
            .append(evenementDestinataireCopie)
            .append("}");
        return sb.toString();
    }
