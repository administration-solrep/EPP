...
public class VersionCriteria {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VersionCriteria: ")
            .append("{evenementId: ")
            .append(evenementId)
            .append(", numeroVersionEquals: ")
            .append(numeroVersionEquals)
            .append(", numeroVersionNotEquals: ")
            .append(numeroVersionNotEquals)
            .append(", currentLifeCycleStateIn: ")
            .append(currentLifeCycleStateIn != null ? StringUtils.join(currentLifeCycleStateIn, ", ") : "null")
            .append(", orderVersionDesc: ")
            .append(orderVersionDesc)
            .append(", dateArNull: ")
            .append(dateArNull)
            .append("}");
