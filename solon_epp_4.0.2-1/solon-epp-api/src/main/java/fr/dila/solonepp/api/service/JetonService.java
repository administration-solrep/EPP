...
public interface JetonService extends fr.dila.st.api.service.JetonService {
     ...
     */
    void createNotificationObjetRefUpdate(
        CoreSession session,
        String objetRefType,
        DocumentModel objetRefDoc,
        String objetRefId
    );
     ...
     * @param objetRefType Type de l'objet de référence réinitialisé (Acteur)...
     */
    void createNotificationObjetRefReset(CoreSession session, String objetRefType);
     ...
     */
    void createNotificationEvenement(
        CoreSession session,
     ...
     */
    void createNotificationEvenement(CoreSession session, DocumentModel evenementDoc, String notificationType);
     ...
     */
    List<DocumentModel> findNotification(CoreSession session, String proprietaireId, String jetonType, long size);
     ...
     */
    Map<String, Object> getNotificationTableReferenceParam(CoreSession session, DocumentModel jetonDocModel);
     ...
     * @return Tableau des paramètres
     */
    Map<String, Object> getNotificationEvenementParam(CoreSession session, DocumentModel jetonDocModel);
     ...
     */
    void sendNotificationEmail(CoreSession session, DocumentModel jetonDoc);
     ...
     * @param jetonDoc Document JetonDoc
     */
    void sendNotificationWebService(CoreSession session, DocumentModel jetonDoc);
     ...
     * @param session Session
     */
    void retryNotification(CoreSession session, BatchLoggerModel batchloggerModel, Long nbError);
     ...
     * @return
     */
    Long getCountJetonsCorbeilleSince(CoreSession session, String corbeille, Calendar date);
     ...
     * @return
     */
    Long getCountJetonsEvenementSince(CoreSession session, String evenementId, Calendar date);
}
