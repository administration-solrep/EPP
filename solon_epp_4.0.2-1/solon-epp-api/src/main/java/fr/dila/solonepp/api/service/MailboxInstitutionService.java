...
public interface MailboxInstitutionService extends Serializable {
     ...
     */
    DocumentModel getMailboxInstitution(CoreSession session, String institutionId);
     ...
     * @return Document Mailbox
     */
    DocumentModel getMailboxInstitutionUnrestricted(CoreSession session, String institutionId);
     ...
     */
    void createAllMailboxInstitution(CoreSession session, DocumentModel mailboxRoot);
}
