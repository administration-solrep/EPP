...
public class EvenementAssembler {
     ...
     * @param eppEvt25Bis
     */
    public void assembleXsdToEvenement(
        final EppEvtContainer eppEvtContainer,
        final fr.dila.solonepp.api.service.version.CreerVersionRequest creerVersionRequest
    ) {
        ...
        if (eppEvtContainer == null) {
            throw new EppNuxeoException("Votre requête ne contient pas de commmunication");
        }
        ...
        if (evenementType == null) {
            throw new EppNuxeoException("Veuillez saisir un type de communication");
        }

        final Assembler assembler = AssemblerFactory.getXsdToObjectAssembler(
            eppEvtContainer,
            session,
            evenementType.value(),
            principal
     ...
     */
    public void assembleXsdToEvenementDelta(
        final EppEvtDelta eppEvtDelta,
            ...
            for (final DeltaMetadonnee deltaMetadonnee : deltaMetadonneeList) {
                ...
                if (propertyDescriptor == null) {
                    throw new NuxeoException(
                        "La propriété " + metadonneeKey + " n'existe pas pour le type de communication " + evenementType
                    );
                }
        ...
        if (deltaPieceJointeList != null) {
            ...
            for (final DocumentModel pieceJointeDoc : pieceJointeDocList) {
                final fr.dila.solonepp.api.domain.evenement.PieceJointe pieceJointe = pieceJointeDoc.getAdapter(
            ...
            for (final DeltaPieceJointe deltaPieceJointe : deltaPieceJointeList) {
                ...
                if (pieceJointeDescriptor == null) {
                    throw new NuxeoException(
                        "La pièce jointe " +
                        pieceJointeType +
                        " n'existe pas pour le type de communication " +
                        evenementType
                    );
                }
    ...
    protected void assembleXsdToPropertyDelta(
        final DeltaMetadonnee deltaMetadonnee,
        final DocumentModel versionDoc,
        ...
        if (propertyDescriptor.isMultiValue()) {
            ...
            if (sourceValueList != null) {
                for (final String sourceValueString : sourceValueList) {
                    ...
                    if (sourceValue == null) {} else if (
                        deltaMetadonnee.isDelete() != null && deltaMetadonnee.isDelete()
                    ) {
     ...
     */
    protected void assemblePieceJointeDelta(
        final DeltaPieceJointe deltaPieceJointe,
        final LinkedHashMultimap<String, DocumentModel> pieceJointeByTypeDocMap,
        final PieceJointeDescriptor pieceJointeDescriptor
    ) {
        ...
        for (final PieceJointe pieceJointe : deltaPieceJointe.getValeur()) {
            final DocumentModel pieceJointeDoc = PieceJointeAssembler.toPieceJointeDoc(session, pieceJointe);
            final fr.dila.solonepp.api.domain.evenement.PieceJointe pieceJointeModel = pieceJointeDoc.getAdapter(
                fr.dila.solonepp.api.domain.evenement.PieceJointe.class
            );
     ...
     */
    protected Object convertValue(final String value, final String propertyType) {
        ...
        if (SolonEppMetaConstant.META_TYPE_STRING.equals(propertyType)) {
            ...
            if (
                ...
                throw new NuxeoException("Commission d'attribution inconnue : " + value);
            }
            return value;
        } else if (SolonEppMetaConstant.META_TYPE_MOTIF_IRRECEVABILITE.equals(propertyType)) {
            if (
                !vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.MOTIF_IRRECEVABILITE_VOCABULARY, value)
            ) {
                throw new NuxeoException("Motif d'irrecevabilité inconnu : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.NIVEAU_LECTURE_VOCABULARY, value)) {
                throw new NuxeoException("Niveau de lecture inconnu : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.NATURE_LOI_VOCABULARY, value)) {
                throw new NuxeoException("Nature de loi inconnue : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.NATURE_RAPPORT_VOCABULARY, value)) {
                throw new NuxeoException("Nature de rapport inconnu : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.TYPE_LOI_VOCABULARY, value)) {
                throw new NuxeoException("Type de loi inconnu : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.SENS_AVIS_VOCABULARY, value)) {
                throw new NuxeoException("Sens d'avis inconnu : " + value);
            }
            return value;
            ...
            if (!vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.SORT_ADOPTION_VOCABULARY, value)) {
                throw new NuxeoException("Sort d'adoption inconnu : " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Acteur inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Circonscription inexistante: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Gouvernement inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Identité inexistante: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Mandat inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Membre de groupe inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Ministère inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Organisme inexistant: " + value);
            }
            return value;
            ...
            if (!exist) {
                throw new NuxeoException("Période inexistante: " + value);
            }
            return value;
        } else {
            throw new NuxeoException("Type de métadonnées inconnu :" + propertyType);
        }
    }
     ...
     * @throws IOException
     */
    public EppEvtContainer assembleEvenementToXsd(
    ...
    public EppEvtContainer assembleEvenementToXsd(
        ...
        final List<DocumentModel> pieceJointeDocList,
        final String messageType,
        final boolean addPjContent
    ) {
        if (dossierDoc == null) {
            throw new NuxeoException("Impossible de récupérer les données du dossier");
        }
        if (evenementDoc == null) {
            throw new NuxeoException("Impossible de récupérer les données de l'évènement");
        }
        if (versionDoc == null) {
            throw new NuxeoException("Impossible de récupérer les données de la version");
        }
        final EppPrincipal principal = (EppPrincipal) session.getPrincipal();
        ...
        if (StringUtils.isNotEmpty(evenementDoc.getId())) {
            ...
            if (evenement.isEtatAnnule()) {
                ...
                throw new NuxeoException(
                    "Etat de la communication inconnu: " + evenementDoc.getCurrentLifeCycleState()
                );
            }
        }
        ...
        if (StringUtils.isNotEmpty(versionDoc.getId())) {
            ...
            final List<DocumentModel> versionVisibleDocList = versionService.findVersionVisible(
                session,
                evenementDoc,
                messageType
            );
        ...
        if (evenement.getTitle() != null) {
            eppBaseEvenement
                .getPieceJointeAjoutee()
                .addAll(pieceJointeService.getPieceJointeAjouteeListe(session, versionDoc, evenementDoc));
            eppBaseEvenement
                .getPieceJointeSupprimee()
                .addAll(pieceJointeService.getPieceJointeSupprimeeListe(session, versionDoc, evenementDoc));
        }
        ...
        final EvenementTypeService evenementTypeService = SolonEppServiceLocator.getEvenementTypeService();
        final List<EvenementTypeDescriptor> evtSuccessifList = evenementTypeService.findEvenementTypeSuccessif(
            session,
            evenement.getTypeEvenement()
        );
        ...
        if (StringUtils.isNotEmpty(evenementDoc.getId())) {
            ...
            final DocumentModel messageDoc = SolonEppServiceLocator
                .getMessageService()
                .getMessageByEvenementId(session, evenementDoc.getTitle());
            if (messageDoc == null) {
            ...
            final List<String> actionPossibleList = versionActionService.findActionPossible(
                session,
                evenementDoc,
                versionDoc,
                messageType,
     ...
     * @return
     */
    protected List<String> assembleMetadonneeModifieeList(final Version version, final String evenementType) {
     ...
     * @return Version WS
     */
    protected fr.sword.xsd.solon.epp.Version assembleVersionToVersionXsd(final DocumentModel versionDoc) {
        ...
        if (StringUtils.isNotEmpty(versionDoc.getId())) {
            ...
            final EtatVersion etatVersion = VersionEtatAssembler.assembleEtatVersionToXsd(
                versionDoc.getCurrentLifeCycleState()
            );
