...
public class NatureLoiAssembler {
     ...
     */
    public static String assembleXsdToNatureLoi(NatureLoi wsId) {
        if (wsId == null) {
            return null;
        }
        ...
        if (vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.NATURE_LOI_VOCABULARY, id)) {
            ...
            throw new NuxeoException("Nature de loi inconnue : " + wsId);
        }
    }
     ...
     */
    public static NatureLoi assembleNatureLoiToXsd(String id) {
        ...
        try {
            ...
            throw new NuxeoException("Nature de loi inconnue : " + id);
        }
    }
}
