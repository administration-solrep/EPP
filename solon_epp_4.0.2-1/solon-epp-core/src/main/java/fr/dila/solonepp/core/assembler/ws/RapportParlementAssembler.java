...
public class RapportParlementAssembler {
     ...
     */
    public static String assembleXsdToRapportParlement(RapportParlement wsId) {
        if (wsId == null) {
            return null;
        }
        ...
        if (vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.RAPPORT_PARLEMENT_VOCABULARY, id)) {
            ...
            throw new NuxeoException("Rapport parlement inconnu : " + wsId);
        }
    }
     ...
     */
    public static RapportParlement assembleRapportParlementToXsd(String id) {
        ...
        try {
            ...
            throw new NuxeoException("Rapport parlement inconnu : " + id);
        }
    }
}
