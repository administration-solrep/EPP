...
public class TypeActeAssembler {
     ...
     */
    public static String assembleXsdToTypeActe(TypeActe wsId) {
        if (wsId == null) {
            return null;
        }
        ...
        if (vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.TYPE_ACTE_VOCABULARY, id)) {
            ...
            throw new NuxeoException("Type d'acte inconnu : " + wsId);
        }
    }
     ...
     */
    public static TypeActe assembleTypeActeToXsd(String id) {
        ...
        try {
            ...
            throw new NuxeoException("Type d'acte inconnu : " + id);
        }
    }
}
