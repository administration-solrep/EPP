...
public class TypeLoiAssembler {
     ...
     */
    public static String assembleXsdToTypeLoi(TypeLoi wsId) {
        if (wsId == null) {
            return null;
        }
        ...
        if (vocabularyService.hasDirectoryEntry(SolonEppVocabularyConstant.TYPE_LOI_VOCABULARY, id)) {
            ...
            throw new NuxeoException("Type de loi inconnue : " + wsId);
        }
    }
     ...
     */
    public static TypeLoi assembleTypeLoiToXsd(String id) {
        ...
        try {
            ...
            throw new NuxeoException("Type de loi inconnue : " + id);
        }
    }
}
