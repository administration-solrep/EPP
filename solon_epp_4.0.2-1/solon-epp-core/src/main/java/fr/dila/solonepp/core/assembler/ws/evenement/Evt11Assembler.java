...
public class Evt11Assembler extends BaseAssembler {
    ...
    public void buildXsd(final Evenement evenement, final Version version) {
        ...
        if (version.getDateRefusProcedureEngagementSenat() != null) {
            eppEvt.setDateRefusSenat(
                DateUtil.calendarToXMLGregorianCalendar(version.getDateRefusProcedureEngagementSenat())
            );
        }
        if (version.getDateRefusEngagementProcedure() != null) {
            eppEvt.setDateRefusEngagementProcedure(
                DateUtil.calendarToXMLGregorianCalendar(version.getDateRefusEngagementProcedure())
            );
        }
    }
