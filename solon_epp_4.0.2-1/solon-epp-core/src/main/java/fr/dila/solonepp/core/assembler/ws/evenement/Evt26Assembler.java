...
import fr.sword.xsd.solon.epp.EppEvt26;
...
/**
 * {@link Assembler} pour {@link EppEvt26}
 *
 * @author asatre
 *
 */
public class Evt26Assembler extends BaseAssembler {
    private final EppEvt26 eppEvt;

    public Evt26Assembler(
        ...
        if (eppEvtContainer != null) {
            eppEvt = eppEvtContainer.getEvt26();
        } else {
            eppEvt = new EppEvt26();
        }
    }
    ...
    public void setEvtInContainer(final EppEvtContainer eppEvtContainerResponse) {
        eppEvtContainerResponse.setType(EvenementType.EVT_26);
        eppEvtContainerResponse.setEvt26(eppEvt);
    }
}
