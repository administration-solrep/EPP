...
public class Lex40Assembler extends BaseAssembler {
    ...
    public void buildObject(final Evenement evenement, final Version version) {
        ...
        if (eppEvt.getDateConferenceAssemblee2() != null) {
            version.setDateConferencePresidentsAssemblee2(
                DateUtil.xmlGregorianCalendarToCalendar(eppEvt.getDateConferenceAssemblee2())
            );
        }
    ...
    public void buildXsd(final Evenement evenement, final Version version) {
        ...
        if (version.getDateConferencePresidentsAssemblee2() != null) {
            eppEvt.setDateConferenceAssemblee2(
                DateUtil.calendarToXMLGregorianCalendar(version.getDateConferencePresidentsAssemblee2())
            );
        }
