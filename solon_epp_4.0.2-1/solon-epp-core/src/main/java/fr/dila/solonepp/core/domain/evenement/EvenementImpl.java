...
public class EvenementImpl implements Evenement {
    ...
    public boolean isEtatInit() {
        return SolonEppLifecycleConstant.EVENEMENT_INIT_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatBrouillon() {
        return SolonEppLifecycleConstant.EVENEMENT_BROUILLON_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatPublie() {
        return SolonEppLifecycleConstant.EVENEMENT_PUBLIE_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatInstance() {
        return SolonEppLifecycleConstant.EVENEMENT_INSTANCE_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatAttenteValidation() {
        return SolonEppLifecycleConstant.EVENEMENT_ATTENTE_VALIDATION_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatAnnule() {
        return SolonEppLifecycleConstant.EVENEMENT_ANNULE_STATE.equals(document.getCurrentLifeCycleState());
    }
