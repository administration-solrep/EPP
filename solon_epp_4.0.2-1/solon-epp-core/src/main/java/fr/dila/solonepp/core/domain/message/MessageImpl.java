...
public class MessageImpl implements Message {
    ...
    public String getSenderMailboxId() {
        return PropertyUtil.getStringProperty(
            document,
            STSchemaConstant.CASE_LINK_SCHEMA,
            STSchemaConstant.CASE_LINK_SENDER_MAILBOX_ID_PROPERTY
        );
    }
    ...
    public String getSender() {
        return PropertyUtil.getStringProperty(
            document,
            STSchemaConstant.CASE_LINK_SCHEMA,
            STSchemaConstant.CASE_LINK_SENDER_PROPERTY
        );
    }
    ...
    public boolean isEtatNonTraite() {
        return SolonEppLifecycleConstant.MESSAGE_NON_TRAITE_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatEnCours() {
        return SolonEppLifecycleConstant.MESSAGE_EN_COURS_STATE.equals(document.getCurrentLifeCycleState());
    }

    @Override
    public boolean isEtatTraite() {
        return SolonEppLifecycleConstant.MESSAGE_TRAITE_STATE.equals(document.getCurrentLifeCycleState());
    }
