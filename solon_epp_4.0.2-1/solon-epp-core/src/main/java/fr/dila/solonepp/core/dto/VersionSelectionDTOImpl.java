...
public class VersionSelectionDTOImpl implements VersionSelectionDTO {
    ...
    public String getDateArAsString() {
        if (dateAr != null) {
            return SolonDateConverter.DATE_DASH.format(dateAr);
        }
        return null;
    }
    ...
    public boolean isEtatRejete() {
        return (
            SolonEppLifecycleConstant.VERSION_REJETE_STATE.equals(etat) ||
            SolonEppLifecycleConstant.VERSION_ABANDONNE_STATE.equals(etat)
        );
    }
}
