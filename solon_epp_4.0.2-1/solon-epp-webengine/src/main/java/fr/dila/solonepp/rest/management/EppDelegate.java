...
public class EppDelegate {
     ...
     * @return Réponse
     */
    public ChercherCorbeilleResponse chercherCorbeille(ChercherCorbeilleRequest request) {
        ...
        List<CorbeilleNode> corbeilleNodeList = corbeilleTypeService.getCorbeilleInstitutionTree(
    ...
    public MajTableResponse majTable(MajTableRequest request) {
        ...
        if (actionObjetReference == null) {
            throw new NuxeoException("Le champ action est obligatoire.");
        }

        ObjetContainer objetContainer = request.getObjetContainer();
        if (objetContainer == null) {
            throw new NuxeoException("Le champ objet_container est obligatoire.");
        }

        ObjetType objetType = objetContainer.getType();
        if (objetType == null) {
            throw new NuxeoException("L'attribut type est obligatoire.");
        }
        ...
        if (objetType.equals(ObjetType.ACTEUR)) {
            ...
            for (fr.sword.xsd.solon.epp.Acteur acteur : acteurs) {
                ...
                if (acteurDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Acteur");
                } else {
                    objetContainerReponse
                        .getActeur()
                        .add(TableReferenceAssembler.toActeurXsd(acteurDocReponse.getAdapter(Acteur.class)));
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Circonscription circonscription : circonscriptions) {
                ...
                circonscriptionDoc =
                    TableReferenceAssembler.toCirconscriptionDoc(session, circonscription, circonscriptionDoc);
                if (creation || renouvellement) {
                    circonscriptionDocReponse =
                        tableReferenceService.createCirconscription(session, circonscriptionDoc);
                } else if (modification) {
                    circonscriptionDocReponse =
                        tableReferenceService.updateCirconscription(session, circonscriptionDoc);
                }
                if (circonscriptionDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Circonscription");
                } else {
                    objetContainerReponse
                        .getCirconscription()
                        .add(
                            TableReferenceAssembler.toCirconscriptionXsd(
                                circonscriptionDocReponse.getAdapter(Circonscription.class)
                            )
                        );
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Gouvernement gouvernement : gouvernements) {
                ...
                if (gouvernementDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Gouvernement");
                } else {
                    objetContainerReponse
                        .getGouvernement()
                        .add(
                            TableReferenceAssembler.toGouvernementXsd(
                                gouvernementDocReponse.getAdapter(Gouvernement.class)
                            )
                        );
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Identite identite : identites) {
                ...
                if (identiteDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Identite");
                } else {
                    objetContainerReponse
                        .getIdentite()
                        .add(TableReferenceAssembler.toIdentiteXsd(identiteDocReponse.getAdapter(Identite.class)));
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Mandat mandat : mandats) {
                ...
                if (
                    StringUtils.isBlank(mandat.getAppellation()) &&
                    (
                        mandat.getType() == TypeMandat.HAUT_COMMISSAIRE ||
                        mandat.getType() == TypeMandat.SECRETARIAT_ETAT ||
                        mandat.getType() == TypeMandat.MINISTERE
                    )
                ) {
                    throw new NuxeoException(
                        "Les mandats de type " + mandat.getType().name() + " doivent avoir une appellation"
                    );
                }
                ...
                if (mandatDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Mandat");
                } else {
                    objetContainerReponse
                        .getMandat()
                        .add(TableReferenceAssembler.toMandatXsd(session, mandatDocReponse));
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.MembreGroupe membreGroupe : membreGroupes) {
                ...
                if (membreGroupeDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet MembreGroupe");
                } else {
                    objetContainerReponse
                        .getMembreGroupe()
                        .add(
                            TableReferenceAssembler.toMembreGroupeXsd(
                                membreGroupeDocReponse.getAdapter(MembreGroupe.class)
                            )
                        );
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Ministere ministere : ministeres) {
                ...
                if (ministereDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Ministere");
                } else {
                    objetContainerReponse
                        .getMinistere()
                        .add(TableReferenceAssembler.toMinistereXsd(ministereDocReponse.getAdapter(Ministere.class)));
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Organisme organisme : organismes) {
                ...
                if (organismeDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Organisme");
                } else {
                    objetContainerReponse
                        .getOrganisme()
                        .add(TableReferenceAssembler.toOrganismeXsd(organismeDocReponse));
                }
            }
            ...
            for (fr.sword.xsd.solon.epp.Periode periode : periodes) {
                ...
                if (periodeDocReponse == null) {
                    throw new NuxeoException("Impossible de créer l'objet Periode");
                } else {
                    objetContainerReponse
                        .getPeriode()
                        .add(TableReferenceAssembler.toPeriodeXsd(periodeDocReponse.getAdapter(Periode.class)));
                }
            }
        }
        response.setStatut(TraitementStatut.OK);
    ...
    public ChercherTableDeReferenceResponse chercherTableDeReference(ChercherTableDeReferenceRequest request) {
        ...
        if (objetType == null) {
            throw new NuxeoException("Le champ ''Type d''objet'' est obligatoire.");
        }
        ...
        if (rechercheParId) {
            if (objetType.equals(ObjetType.ACTEUR)) {
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (circonscriptionModel != null) {
                        ...
                        objetResponse
                            .getCirconscription()
                            .add(TableReferenceAssembler.toCirconscriptionXsd(circonscription));
                    }
                }
            } else if (objetType.equals(ObjetType.GOUVERNEMENT)) {
                for (String idObjet : idObjets) {
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getAttributionCommission()
                            .add(VocabulaireReferenceAssembler.toAttributionCommissionReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getNatureLoi()
                            .add(VocabulaireReferenceAssembler.toNatureLoiReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getNatureRapport()
                            .add(VocabulaireReferenceAssembler.toNatureRapportReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getSortAdoption()
                            .add(VocabulaireReferenceAssembler.toSortAdoptionReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getMotifIrrecevabilite()
                            .add(VocabulaireReferenceAssembler.toMotifIrrecevabiliteReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getNiveauLectureCode()
                            .add(VocabulaireReferenceAssembler.toNiveauLectureCodeReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getRapportParlement()
                            .add(VocabulaireReferenceAssembler.toRapportParlementReferenceXsd(docModel));
                    }
                }
                ...
                for (String idObjet : idObjets) {
                    ...
                    if (docModel != null) {
                        objetResponse
                            .getResultatCmp()
                            .add(VocabulaireReferenceAssembler.toResultatCmpReferenceXsd(docModel));
                    }
                }
                ...
                throw new NuxeoException("ObjetType incorrect");
            }
            ...
            if (objetType.equals(ObjetType.ACTEUR)) {
                ...
                List<DocumentModel> circonscriptionModelList = tableReferenceService.findAllCirconscription(
                    session,
                    false
                );
                for (DocumentModel circonscriptionModel : circonscriptionModelList) {
                    ...
                    if (
                        ...
                        (
                            !request.isActifsUniquement() ||
                            circonscription.getDateFin() == null ||
                            circonscription.getDateFin() != null &&
                            circonscription.getDateFin().after(now)
                        )
                    ) {
                        objetResponse
                            .getCirconscription()
                ...
                List<String> hasChild = tableReferenceService.findAllNodeHasChild(
                    session,
                ...
                for (DocumentModel gouvernementModel : gouvernementModelList) {
                    ...
                    if (
                        ...
                        (
                            !request.isActifsUniquement() ||
                            gouvernement.getDateFin() == null ||
                            gouvernement.getDateFin() != null &&
                            gouvernement.getDateFin().after(now)
                        )
                    ) {
                ...
                if (parentId != null && parentId.equals("Mandats sans Ministeres")) {
                    ...
                    mandatModelList =
                        (parentId != null)
                            ? tableReferenceService.findAllMandatByMin(session, parentId)
                ...
                for (DocumentModel membreGroupeModel : membreGroupeModelList) {
                    ...
                    if (
                        ...
                        (
                            !request.isActifsUniquement() ||
                            membreGroupe.getDateFin() == null ||
                            membreGroupe.getDateFin() != null &&
                            membreGroupe.getDateFin().after(now)
                        )
                    ) {
                        objetResponse.getMembreGroupe().add(TableReferenceAssembler.toMembreGroupeXsd(membreGroupe));
                    }
                ...
                List<DocumentModel> ministereModelList = (parentId != null)
                    ? tableReferenceService.findAllMinistereByGov(session, parentId)
                    : tableReferenceService.findAllMinistere(session);
                List<String> hasChild = tableReferenceService.findAllNodeHasChild(
                    session,
                ...
                for (DocumentModel ministereModel : ministereModelList) {
                    ...
                    if (
                        ...
                        (
                            ...
                            ministere.getDateFin() != null &&
                            ministere.getDateFin().after(now)
                        )
                    ) {
                ...
                for (DocumentModel organismeModel : organismeModelList) {
                    ...
                    if (
                        ...
                        (
                            !request.isActifsUniquement() ||
                            organisme.getDateFin() == null ||
                            organisme.getDateFin() != null &&
                            organisme.getDateFin().toGregorianCalendar().after(now)
                        )
                    ) {
    ...
    public ChercherIdentiteResponse chercherIdentite(ChercherIdentiteRequest request) {
        ...
        for (DescriptifRequete descriptif : request.getDescriptifRequete()) {
            ...
            if (
                descriptif.getNom() == null || descriptif.getPrenom() == null || descriptif.getDateNaissance() == null
            ) {
                continue;
            }
            List<DocumentModel> identitesModels = tableReferenceService.findAllIdentiteByDescription(
                session,
                descriptif.getNom(),
                descriptif.getPrenom(),
                descriptif.getDateNaissance().toGregorianCalendar()
            );
     ...
     * @return Réponse
     */
    public NotifierTransitionResponse notifierTransition(NotifierTransitionRequest request) {
        NotifierTransitionResponse response = new NotifierTransitionResponse();

        String evenementId = checkIdEvenement(request.getIdEvenement());
        ...
        if (EtatMessage.EN_COURS_TRAITEMENT.equals(etatMessage)) {
            ...
            throw new NuxeoException("Interdiction de transitionner dans l'état " + etatMessage);
        }
     ...
     * @return Réponse
     */
    public ChercherDossierResponse chercherDossier(ChercherDossierRequest request) {
        ...
        List<String> dossierIdList = request
            .getIdDossier()
            .stream()
            .map(this::checkIdDossier)
        ...
        for (String dossierId : dossierIdList) {
            ...
            if (dossierDocTmp != null) {
                ...
                for (DocumentModel evtDoc : evtList) {
                    ...
                    fr.dila.solonepp.api.domain.message.Message message = messageDoc.getAdapter(
                    ...
                    EppEvtContainer eppEvtContainer = evenementAssembler.assembleEvenementToXsd(
                        dossierDocTmp,
                        evtDoc,
                        versionDoc,
                        pjList,
        ...
        if (hasDossier) {
            ...
            throw new DossierNotFoundException(
                "Pas de dossiers trouvés pour les identifiants : " + StringHelper.join(dossierIdList, ",", "'")
            );
        }
        return response;
    }
     ...
     * @return
     */
    public NotifierVerrouResponse notifierVerrou(NotifierVerrouRequest request) {
        NotifierVerrouResponse response = new NotifierVerrouResponse();

        EppPrincipal principal = (EppPrincipal) session.getPrincipal();

        String idEvt = checkIdEvenement(request.getIdEvenement());
        ...
        String locker = null;
        Lock lock = lockService.getLockDetails(session, messageDoc);
        if (lock != null) {
            locker = lock.getOwner();
        }
        if (request.isForcerVerrou()) {
            if (!StringUtils.equals(locker, principal.getName())) {
    ...
    public HasCommunicationNonTraiteesResponse hasCommunication(HasCommunicationNonTraiteesRequest request) {
        ...
        if (idCorbeilles.isEmpty()) {
            final CorbeilleTypeService corbeilleTypeService = SolonEppServiceLocator.getCorbeilleTypeService();
            EppPrincipal principal = (EppPrincipal) session.getPrincipal();
            List<CorbeilleNode> corbeilleList = corbeilleTypeService.getCorbeilleInstitutionTree(
                principal.getInstitutionId()
            );
     ...
     * @param response
     */
    private void setCorbeilleInfos(
        CorbeilleNode node,
        CorbeilleService corbeilleService,
    ...
    public TransmissionDatePublicationJOResponse transmissionDatePublicationJO(
        final TransmissionDatePublicationJORequest request
    ) {
        final TransmissionDatePublicationJOResponse response = new TransmissionDatePublicationJOResponse();
        response.setStatut(TraitementStatut.OK);
        final DossierService dossierService = SolonEppServiceLocator.getDossierService();
        final String idDossier = checkIdDossier(request.getIdDossier());
    ...
    private String checkIdEvenement(String idEvenement) {
        final EvenementService evenementService = SolonEppServiceLocator.getEvenementService();
        if (idEvenement != null && !evenementService.isIdEvenementValid(idEvenement)) {
            throw new NuxeoException(String.format("Le format de l'idEvenement [%s] est invalide", idEvenement));
        }
        return idEvenement;
    }
}
